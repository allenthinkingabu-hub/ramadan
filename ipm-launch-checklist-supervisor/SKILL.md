---
name: ipm-launch-checklist-supervisor
description: "Supervisor inspection skill for ipm-launch-checklist. Use when: (1) IPM agent completes self-check for task IPM-QA-003, (2) SupervisorTriggered event received from ipm-launch-checklist skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# IPM Launch Checklist — Supervisor

Role: IT Product Manager Supervisor | Task ID: IPM-QA-003 | Inspection Agent

## Inspection Scope

Independent quality review of the Launch Checklist output for task IPM-QA-003. This supervisor:
- Operates independently from the IPM Launch Checklist agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the IPM Launch Checklist agent sends SupervisorTriggered event with:
...
```
[Trigger] IPM Launch Checklist agent sends SupervisorTriggered
     |
     v
...
```markdown
# IPM Launch Checklist Supervisor Inspection Report
