---
name: pm-risk-issue-management
description: "IT Project Manager skill for Continuously updating the risk register, managing issue logs, and driving resolution of escalated blockers. Use when: (1) PM assigns task PM-DEV-002 via TaskTriggered event, (2) Development phase risk & issue management activities are needed, (3) orchestrating risk & issue management deliverables for downstream team tasks."
---

# PM Risk & Issue Management

Role: IT Project Manager | Task ID: PM-DEV-002 | Wave: 1, Step: 2

## Objective

Continuously updating the risk register, managing issue logs, and driving resolution of escalated blockers.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-DEV-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why risk & issue management is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-risk-issue-management-supervisor`
