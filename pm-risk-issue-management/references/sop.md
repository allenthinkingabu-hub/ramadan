# Standard Operating Procedure (SOP) — PM-DEV-002 Risk & Issue Management

## Overview

Step-by-step process from receiving the Risk & Issue Management task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-DEV-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-risk-issue-management-supervisor | Signal sent |
