# Trigger Configuration — PM-INC-002 Stakeholder Analysis

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-INC-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests stakeholder analysis for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-stakeholder-analysis-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Stakeholder Analysis is finalized (after supervisor approval) |
