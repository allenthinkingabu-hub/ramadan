# Definition of Ready (DoR) — PM-INC-002 Stakeholder Analysis

Prerequisites that must be satisfied before starting Stakeholder Analysis.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-INC-002/` |
