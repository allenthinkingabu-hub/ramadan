---
name: sa-technical-standards-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the sa-technical-standards agent output. Use when: (1) the Technical Standards Agent (IA-REQ-005) completes one round of output and needs quality inspection, (2) verifying all required deliverables of the technical standards task are complete and valid (including standards enforcement view and NFR alignment note), or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# SA Technical Standards Supervisor Agent

Role: Quality Supervisor | Parent Task: IA-REQ-005 Technical Standards | Wave: 10, Step: 5

Operates independently from the Technical Standards Agent. Does not participate in the design -- only reviews and provides feedback.

## Trigger

Automatically triggered after the Technical Standards AI Agent completes one round of output.
...
| 14 | Standards enforcement view | `diagrams/standards-enforcement-view.md` exists with linting, review checklist, CI/CD gates, automated vs. manual matrix |
| 15 | NFR alignment note | `nfr-alignment.md` exists with NFR mapping, constraints, assumptions, code quality SLO/SLI targets |
| 16 | Standards completeness | Coding standards, design patterns, error handling, logging, testing, and security standards all covered |
...
| Item 14: Standards Enforcement View | PASS / FAIL | {notes} |
| Item 15: NFR Alignment Note | PASS / FAIL | {notes} |
| Item 16: Standards Completeness | PASS / FAIL | {notes} |
