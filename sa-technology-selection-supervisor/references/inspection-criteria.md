# Inspection Criteria — sa-technology-selection-supervisor

## Detailed Verification Criteria

### Item 1: Trigger Mechanism Config
- **File**: `technology-selection/config/triggers.yaml`
- **Checks**:
  - File exists and is valid YAML
  - Contains at least one trigger event definition
  - Each trigger has: id, event, source, condition fields
  - Metadata section includes task_id "IA-INC-003"

### Item 2: RACI Matrix Config
- **File**: `technology-selection/config/raci.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/config/skills.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/config/knowledge-domains.yaml`
- **Checks**:
  - File exists and is valid YAML
...
### Item 5: Tools List
- **File**: `technology-selection/config/tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/config/mcp-tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **Files**: `technology-selection/config/outputs.yaml` + `technology-selection/templates/`
- **Checks**:
...
- **File**: `technology-selection/config/sop.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/config/dod.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/config/dor.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technology-selection/conversation-log.md`
- **Checks**:
...
### Item 12: Work Log
- **File**: `technology-selection/work-log.md`
- **Checks**:
  - File exists and is non-empty
...
- **Checks**:
  ...
  - Technology Selection report exists with complete evaluation content
