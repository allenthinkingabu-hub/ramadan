# Trigger Configuration — IA-INC-007 Compliance & Privacy Scan

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-INC-007 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests compliance & privacy scan for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-compliance-privacy-scan-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Compliance & Privacy Scan is finalized (after supervisor approval) |
