---
name: tl-technical-vision-direction-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the tl-technical-vision-direction agent output. Use when: (1) the Technical Vision & Direction Agent (TL-INC-001) completes one round of output and needs quality inspection, (2) verifying all required deliverables of the technical vision task are complete and valid, or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# TL Technical Vision & Direction Supervisor Agent

Role: Quality Supervisor | Parent Task: TL-INC-001 Technical Vision & Direction | Wave: 11, Step: 1

Operates independently from the Technical Vision & Direction Agent. Does not participate in the vision definition — only reviews and provides feedback.

## Trigger

Automatically triggered after the Technical Vision & Direction AI Agent completes one round of output.
...
| 14 | Technical Vision Statement | `technical-vision-statement.md` exists with clear vision articulation, time horizon, and business alignment |
| 15 | Guiding Principles | `guiding-principles.md` exists with core principles and trade-off decision framework |
| 16 | Business-Technology Alignment | `alignment-matrix.md` exists with objective-to-capability mapping and gap analysis |
| 17 | Upstream traceability | IA-INC-001..008 references present, vision decisions traceable to architect inputs |
...
| Item 14: Technical Vision Statement | PASS / FAIL | {notes} |
| Item 15: Guiding Principles | PASS / FAIL | {notes} |
| Item 16: Business-Technology Alignment | PASS / FAIL | {notes} |
