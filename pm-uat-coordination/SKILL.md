---
name: pm-uat-coordination
description: "IT Project Manager skill for Planning UAT timelines, coordinating business user participation, and ensuring environment readiness. Use when: (1) PM assigns task PM-QA-001 via TaskTriggered event, (2) QA phase uat coordination activities are needed, (3) orchestrating uat coordination deliverables for downstream team tasks."
---

# PM UAT Coordination

Role: IT Project Manager | Task ID: PM-QA-001 | Wave: 1, Step: 1

## Objective

Planning UAT timelines, coordinating business user participation, and ensuring environment readiness.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-QA-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why uat coordination is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-uat-coordination-supervisor`
