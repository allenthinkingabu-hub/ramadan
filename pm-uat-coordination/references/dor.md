# Definition of Ready (DoR) — PM-QA-001 UAT Coordination

Prerequisites that must be satisfied before starting UAT Coordination.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-QA-001/` |
