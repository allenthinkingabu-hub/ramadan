# Output Template — PM-QA-001 UAT Coordination

Use this template as the strict structure for all UAT Coordination deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — UAT Coordination Document |
...
{{Core content specific to UAT Coordination. Structure according to the deliverable type.}}
