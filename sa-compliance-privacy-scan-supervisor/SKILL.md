---
name: sa-compliance-privacy-scan-supervisor
description: "Supervisor inspection skill for sa-compliance-privacy-scan. Use when: (1) SA agent completes self-check for task IA-INC-007, (2) SupervisorTriggered event received from sa-compliance-privacy-scan skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Compliance & Privacy Scan — Supervisor

Role: System Architect Supervisor | Task ID: IA-INC-007 | Inspection Agent

## Inspection Scope

Independent quality review of the Compliance & Privacy Scan output for task IA-INC-007. This supervisor:
- Operates independently from the SA Compliance & Privacy Scan agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Compliance & Privacy Scan agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Compliance & Privacy Scan agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Compliance & Privacy Scan Supervisor Inspection Report
