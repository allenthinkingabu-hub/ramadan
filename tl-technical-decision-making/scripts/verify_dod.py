#!/usr/bin/env python3
"""DoD Self-Verification Script for tl-technical-decision-making Agent.

Checks all DoD items and reports pass/fail status.

Usage:
    python3 verify_dod.py <technical-decision-making-dir>

Example:
    python3 verify_dod.py ./technical-decision-making
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 verify_dod.py <technical-decision-making-dir>")
        sys.exit(1)
    ...
    results.append(("DoD-14", "Technical Decision Making report",
                     *check_md_file(base / "technical-decision-making-report.md")))
    ...
    results.append(("DoD-17", "Trade-off analysis", *check_md_file(base / "trade-off-analysis.md")))
    results.append(("DoD-18", "Decision register", *check_md_file(base / "decision-register.md")))

    passed = sum(1 for r in results if r[2])
    total = len(results)

    print(f"\n{'='*70}")
    print(f"DoD Verification Report -- Technical Decision Making (TL-DEV-003)")
