# Definition of Ready (DoR) -- sa-data-architecture
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or system to design data architecture for |
| DoR-02 | Scope is defined or definable | Yes | Data domains and scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `data-architecture/` |
...
| DoR-13 | Business & technical requirements | Yes | Data requirements available or obtainable through dialogue |
