---
name: sa-architecture-design-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the sa-architecture-design agent output. Use when: (1) the Architecture Design Agent (IA-REQ-001) completes one round of output and needs quality inspection, (2) verifying all required deliverables of the architecture design task are complete and valid (including interface/integration view and NFR alignment note), or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# SA Architecture Design Supervisor Agent

Role: Quality Supervisor | Parent Task: IA-REQ-001 Architecture Design | Wave: 10, Step: 1

Operates independently from the Architecture Design Agent. Does not participate in the design — only reviews and provides feedback.

## Trigger

Automatically triggered after the Architecture Design AI Agent completes one round of output.
