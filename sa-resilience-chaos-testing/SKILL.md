---
name: sa-resilience-chaos-testing
description: "System Architect skill for Designing and running chaos or game-day exercises to validate failure modes and recovery paths. Use when: (1) PM assigns task IA-REL-008 via TaskTriggered event, (2) Release phase resilience/chaos testing activities are needed, (3) orchestrating resilience/chaos testing deliverables for downstream team tasks."
---

# SA Resilience/Chaos Testing

Role: System Architect | Task ID: IA-REL-008 | Wave: 10, Step: 8

## Objective

Designing and running chaos or game-day exercises to validate failure modes and recovery paths.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-008/`
...
2. Analyze and summarize understanding of the **task purpose** (why resilience/chaos testing is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-resilience-chaos-testing-supervisor`
