# Definition of Ready (DoR) — IA-REL-008 Resilience/Chaos Testing

Prerequisites that must be satisfied before starting Resilience/Chaos Testing.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-008/` |
