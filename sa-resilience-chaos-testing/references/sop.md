# Standard Operating Procedure (SOP) — IA-REL-008 Resilience/Chaos Testing

## Overview

Step-by-step process from receiving the Resilience/Chaos Testing task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-008/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-resilience-chaos-testing-supervisor | Signal sent |
