# Definition of Done (DoD) — IA-REL-008 Resilience/Chaos Testing

Quality gates that must ALL pass for Resilience/Chaos Testing deliverables to be considered complete.
