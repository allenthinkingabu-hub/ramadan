# Output Template — IA-REL-008 Resilience/Chaos Testing

Use this template as the strict structure for all Resilience/Chaos Testing deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Resilience/Chaos Testing Document |
...
{{Core content specific to Resilience/Chaos Testing. Structure according to the deliverable type.}}
