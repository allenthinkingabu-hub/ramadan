# Trigger Configuration — IA-REL-008 Resilience/Chaos Testing

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-REL-008 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests resilience/chaos testing for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-resilience-chaos-testing-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Resilience/Chaos Testing is finalized (after supervisor approval) |
