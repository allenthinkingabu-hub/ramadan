# Standard Operating Procedure (SOP) — IPM-INC-001 Requirement Gathering

## Overview

Step-by-step process from receiving the Requirement Gathering task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-INC-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-requirement-gathering-supervisor | Signal sent |
