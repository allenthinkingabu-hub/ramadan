# Output Template — IPM-INC-001 Requirement Gathering

Use this template as the strict structure for all Requirement Gathering deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Requirement Gathering Document |
...
{{Core content specific to Requirement Gathering. Structure according to the deliverable type.}}
