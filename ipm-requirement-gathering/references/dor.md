# Definition of Ready (DoR) — IPM-INC-001 Requirement Gathering

Prerequisites that must be satisfied before starting Requirement Gathering.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-INC-001/` |
