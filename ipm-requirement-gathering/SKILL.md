---
name: ipm-requirement-gathering
description: "IT Product Manager skill for In-depth interviews with stakeholders/customers to collect raw requirements. Use when: (1) PM assigns task IPM-INC-001 via TaskTriggered event, (2) Inception phase requirement gathering activities are needed, (3) orchestrating requirement gathering deliverables for downstream team tasks."
---

# IPM Requirement Gathering

Role: IT Product Manager | Task ID: IPM-INC-001 | Wave: 2, Step: 1

## Objective

In-depth interviews with stakeholders/customers to collect raw requirements.
...
- SM-INC-001, SM-INC-002, SM-INC-003, SM-INC-004, SM-INC-005

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-INC-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why requirement gathering is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-requirement-gathering-supervisor`
