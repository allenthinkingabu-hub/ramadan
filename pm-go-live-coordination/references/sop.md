# Standard Operating Procedure (SOP) — PM-REL-001 Go-Live Coordination

## Overview

Step-by-step process from receiving the Go-Live Coordination task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REL-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-go-live-coordination-supervisor | Signal sent |
