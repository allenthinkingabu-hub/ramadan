# Definition of Ready (DoR) — sa-technology-selection
...
|:---|:---|:---|
| DoR-01 | Topic is provided | User has supplied the project or system to select technologies for |
| DoR-02 | Scope is defined or definable | Evaluation scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Parent directory exists and agent can create `technology-selection/` |
| DoR-05 | Research tools available | Web Search or equivalent tools are accessible |
| DoR-06 | Upstream inputs available (recommended) | Technical Discovery (IA-INC-001) and/or Feasibility Analysis (IA-INC-002) reports if applicable |
...
4. Check for upstream reports (IA-INC-001, IA-INC-002) → if available, load as context
