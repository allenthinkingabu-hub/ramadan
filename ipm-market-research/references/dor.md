# Definition of Ready (DoR) — IPM-INC-002 Market Research

Prerequisites that must be satisfied before starting Market Research.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-INC-002/` |
