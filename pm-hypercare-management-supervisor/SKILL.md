---
name: pm-hypercare-management-supervisor
description: "Supervisor inspection skill for pm-hypercare-management. Use when: (1) PM agent completes self-check for task PM-REL-002, (2) SupervisorTriggered event received from pm-hypercare-management skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Hypercare Management — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REL-002 | Inspection Agent

## Inspection Scope

Independent quality review of the Hypercare Management output for task PM-REL-002. This supervisor:
- Operates independently from the PM Hypercare Management agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Hypercare Management agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Hypercare Management agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Hypercare Management Supervisor Inspection Report
