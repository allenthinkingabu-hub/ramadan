# RACI Matrix — IA-REQ-009 Requirements Traceability & Compliance Mapping
...
| ID | Role | Description |
|----|------|-------------|
| SA | System Architect | Primary executor; produces and delivers Requirements Traceability & Compliance Mapping outputs |
...
| ID | Task | SA | PM | SPONSOR | SME | END_USER | ARCHITECT | QA |
|----|------|-----|-----|---------|-----|----------|-----------|-----|
