# RACI Matrix — PM-REL-004 Lessons Learned & Retrospective
...
| ID | Role | Description |
|----|------|-------------|
| PM | IT Project Manager | Primary executor; produces and delivers Lessons Learned & Retrospective outputs |
