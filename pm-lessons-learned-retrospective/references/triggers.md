# Trigger Configuration — PM-REL-004 Lessons Learned & Retrospective

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REL-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests lessons learned & retrospective for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-lessons-learned-retrospective-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Lessons Learned & Retrospective is finalized (after supervisor approval) |
