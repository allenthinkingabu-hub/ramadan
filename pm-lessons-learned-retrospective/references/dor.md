# Definition of Ready (DoR) — PM-REL-004 Lessons Learned & Retrospective

Prerequisites that must be satisfied before starting Lessons Learned & Retrospective.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REL-004/` |
