---
name: pm-lessons-learned-retrospective
description: "IT Project Manager skill for Facilitating post-project retrospectives to capture successes, challenges, and improvement recommendations. Use when: (1) PM assigns task PM-REL-004 via TaskTriggered event, (2) Release phase lessons learned & retrospective activities are needed, (3) orchestrating lessons learned & retrospective deliverables for downstream team tasks."
---

# PM Lessons Learned & Retrospective

Role: IT Project Manager | Task ID: PM-REL-004 | Wave: 1, Step: 4

## Objective

Facilitating post-project retrospectives to capture successes, challenges, and improvement recommendations.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REL-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why lessons learned & retrospective is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-lessons-learned-retrospective-supervisor`
