---
name: ipm-prioritization
description: "IT Product Manager skill for Ranking requirements using frameworks like MoSCoW or RICE. Use when: (1) PM assigns task IPM-REQ-003 via TaskTriggered event, (2) Requirements phase prioritization activities are needed, (3) orchestrating prioritization deliverables for downstream team tasks."
---

# IPM Prioritization

Role: IT Product Manager | Task ID: IPM-REQ-003 | Wave: 2, Step: 3

## Objective

Ranking requirements using frameworks like MoSCoW or RICE.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why prioritization is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-prioritization-supervisor`
