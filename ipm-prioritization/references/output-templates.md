# Output Template — IPM-REQ-003 Prioritization

Use this template as the strict structure for all Prioritization deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Prioritization Document |
...
{{Core content specific to Prioritization. Structure according to the deliverable type.}}
