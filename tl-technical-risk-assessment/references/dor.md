# Definition of Ready (DoR) — tl-technical-risk-assessment
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or system for risk assessment |
| DoR-02 | Scope is defined or definable | Yes | Risk assessment scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `technical-risk-assessment/` |
...
| DoR-10 | IA-INC-005: Technology Landscape Assessment | Recommended | Technology landscape from Wave 10 |
| DoR-11 | IA-INC-006: Risk Assessment | Recommended | IT Architect's risk analysis from Wave 10 |
...
| DoR-14 | System architecture overview | Yes | Architecture documentation or context available or obtainable through dialogue |
...
5. Check for system architecture documentation -> if available, load as additional context
