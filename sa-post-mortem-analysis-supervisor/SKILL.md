---
name: sa-post-mortem-analysis-supervisor
description: "Supervisor inspection skill for sa-post-mortem-analysis. Use when: (1) SA agent completes self-check for task IA-REL-004, (2) SupervisorTriggered event received from sa-post-mortem-analysis skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Post-Mortem Analysis — Supervisor

Role: System Architect Supervisor | Task ID: IA-REL-004 | Inspection Agent

## Inspection Scope

Independent quality review of the Post-Mortem Analysis output for task IA-REL-004. This supervisor:
- Operates independently from the SA Post-Mortem Analysis agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Post-Mortem Analysis agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Post-Mortem Analysis agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Post-Mortem Analysis Supervisor Inspection Report
