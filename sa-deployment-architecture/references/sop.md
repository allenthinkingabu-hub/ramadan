# Standard Operating Procedure (SOP) — IA-REL-001 Deployment Architecture

## Overview

Step-by-step process from receiving the Deployment Architecture task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-deployment-architecture-supervisor | Signal sent |
