# Definition of Done (DoD) — PM-REQ-005 Vendor & Procurement Management

Quality gates that must ALL pass for Vendor & Procurement Management deliverables to be considered complete.
