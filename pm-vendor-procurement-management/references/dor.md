# Definition of Ready (DoR) — PM-REQ-005 Vendor & Procurement Management

Prerequisites that must be satisfied before starting Vendor & Procurement Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REQ-005/` |
