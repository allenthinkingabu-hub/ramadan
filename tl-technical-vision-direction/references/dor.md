# Definition of Ready (DoR) — tl-technical-vision-direction
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or product for which technical vision is needed |
| DoR-02 | Scope is defined or definable | Yes | Vision scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `technical-vision-direction/` |
| DoR-05 | Research tools available | Yes | Web Search or equivalent tools are accessible |
| DoR-06 | IA-INC-001: Technical Discovery Report | Recommended | IT Architect's technical discovery from Wave 10 available for reference |
| DoR-07 | IA-INC-002: Feasibility Analysis | Recommended | Feasibility study results from Wave 10 |
| DoR-08 | IA-INC-003: Proof of Concept Results | Recommended | PoC findings and conclusions from Wave 10 |
| DoR-09 | IA-INC-004: NFR Analysis | Recommended | Non-functional requirements analysis from Wave 10 |
...
| DoR-13 | IA-INC-008: Architecture Patterns Evaluation | Recommended | Architecture patterns analysis from Wave 10 |
| DoR-14 | Business objectives documented | Yes | Business goals and strategic priorities available or obtainable through dialogue |
...
5. Check for business objectives documentation -> if available, load as additional context
