# Standard Operating Procedure (SOP) — PM-REQ-001 Project Plan & WBS

## Overview

Step-by-step process from receiving the Project Plan & WBS task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REQ-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-project-plan-wbs-supervisor | Signal sent |
