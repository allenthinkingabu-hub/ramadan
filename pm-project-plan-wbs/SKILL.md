---
name: pm-project-plan-wbs
description: "IT Project Manager skill for Creating the detailed project plan with Work Breakdown Structure, milestones, and critical path analysis. Use when: (1) PM assigns task PM-REQ-001 via TaskTriggered event, (2) Requirements phase project plan & wbs activities are needed, (3) orchestrating project plan & wbs deliverables for downstream team tasks."
---

# PM Project Plan & WBS

Role: IT Project Manager | Task ID: PM-REQ-001 | Wave: 1, Step: 1

## Objective

Creating the detailed project plan with Work Breakdown Structure, milestones, and critical path analysis.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REQ-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why project plan & wbs is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-project-plan-wbs-supervisor`
