...
- **File**: `technical-discovery/config/skills.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technical-discovery/config/knowledge-domains.yaml`
- **Checks**:
  - File exists and is valid YAML
...
### Item 5: Tools List
- **File**: `technical-discovery/config/tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technical-discovery/config/mcp-tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **Files**: `technical-discovery/config/outputs.yaml` + `technical-discovery/templates/`
- **Checks**:
...
- **File**: `technical-discovery/config/sop.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technical-discovery/config/dod.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technical-discovery/config/dor.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `technical-discovery/conversation-log.md`
- **Checks**:
...
### Item 12: Work Log
- **File**: `technical-discovery/work-log.md`
- **Checks**:
  - File exists and is non-empty
