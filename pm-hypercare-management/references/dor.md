# Definition of Ready (DoR) — PM-REL-002 Hypercare Management

Prerequisites that must be satisfied before starting Hypercare Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REL-002/` |
