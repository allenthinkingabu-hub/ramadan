---
name: pm-hypercare-management
description: "IT Project Manager skill for Managing the post-launch support period with dedicated resources, escalation procedures, and rapid response. Use when: (1) PM assigns task PM-REL-002 via TaskTriggered event, (2) Release phase hypercare management activities are needed, (3) orchestrating hypercare management deliverables for downstream team tasks."
---

# PM Hypercare Management

Role: IT Project Manager | Task ID: PM-REL-002 | Wave: 1, Step: 2

## Objective

Managing the post-launch support period with dedicated resources, escalation procedures, and rapid response.

## Upstream Inputs

- **User / Organization**: Project initiation request and strategic objectives
- **Previous PM phase outputs**: Completed Release prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- IPM-REL-001, IPM-REL-002, IPM-REL-003, IPM-REL-004

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REL-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why hypercare management is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-hypercare-management-supervisor`
