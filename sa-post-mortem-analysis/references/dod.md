# Definition of Done (DoD) — IA-REL-004 Post-Mortem Analysis

Quality gates that must ALL pass for Post-Mortem Analysis deliverables to be considered complete.
