# Output Template — IA-REL-004 Post-Mortem Analysis

Use this template as the strict structure for all Post-Mortem Analysis deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Post-Mortem Analysis Document |
...
{{Core content specific to Post-Mortem Analysis. Structure according to the deliverable type.}}
