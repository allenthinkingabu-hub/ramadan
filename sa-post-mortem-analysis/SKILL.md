---
name: sa-post-mortem-analysis
description: "System Architect skill for Leading technical root-cause analysis for production incidents and outages. Use when: (1) PM assigns task IA-REL-004 via TaskTriggered event, (2) Release phase post-mortem analysis activities are needed, (3) orchestrating post-mortem analysis deliverables for downstream team tasks."
---

# SA Post-Mortem Analysis

Role: System Architect | Task ID: IA-REL-004 | Wave: 10, Step: 4

## Objective

Leading technical root-cause analysis for production incidents and outages.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why post-mortem analysis is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-post-mortem-analysis-supervisor`
