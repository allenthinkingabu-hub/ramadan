# Standard Operating Procedure (SOP) — IA-REL-006 Runbooks & Knowledge Transfer

## Overview

Step-by-step process from receiving the Runbooks & Knowledge Transfer task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-006/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-runbooks-knowledge-transfer-supervisor | Signal sent |
