# Definition of Ready (DoR) — IPM-REQ-001 PRD Writing

Prerequisites that must be satisfied before starting PRD Writing.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-001/` |
