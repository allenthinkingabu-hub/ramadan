# Output Template — IPM-REQ-001 PRD Writing

Use this template as the strict structure for all PRD Writing deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — PRD Writing Document |
...
{{Core content specific to PRD Writing. Structure according to the deliverable type.}}
