# Definition of Ready (DoR) — PM-REQ-004 Communication Plan

Prerequisites that must be satisfied before starting Communication Plan.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REQ-004/` |
