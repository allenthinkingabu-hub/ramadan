# Trigger Configuration — PM-REQ-004 Communication Plan

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REQ-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests communication plan for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-communication-plan-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Communication Plan is finalized (after supervisor approval) |
