# Standard Operating Procedure (SOP) — PM-REQ-004 Communication Plan

## Overview

Step-by-step process from receiving the Communication Plan task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REQ-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-communication-plan-supervisor | Signal sent |
