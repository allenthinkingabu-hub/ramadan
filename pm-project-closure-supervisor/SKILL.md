---
name: pm-project-closure-supervisor
description: "Supervisor inspection skill for pm-project-closure. Use when: (1) PM agent completes self-check for task PM-REL-003, (2) SupervisorTriggered event received from pm-project-closure skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Project Closure — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REL-003 | Inspection Agent

## Inspection Scope

Independent quality review of the Project Closure output for task PM-REL-003. This supervisor:
- Operates independently from the PM Project Closure agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Project Closure agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Project Closure agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Project Closure Supervisor Inspection Report
