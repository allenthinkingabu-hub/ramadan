---
name: sa-runbooks-knowledge-transfer-supervisor
description: "Supervisor inspection skill for sa-runbooks-knowledge-transfer. Use when: (1) SA agent completes self-check for task IA-REL-006, (2) SupervisorTriggered event received from sa-runbooks-knowledge-transfer skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Runbooks & Knowledge Transfer — Supervisor

Role: System Architect Supervisor | Task ID: IA-REL-006 | Inspection Agent

## Inspection Scope

Independent quality review of the Runbooks & Knowledge Transfer output for task IA-REL-006. This supervisor:
- Operates independently from the SA Runbooks & Knowledge Transfer agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Runbooks & Knowledge Transfer agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Runbooks & Knowledge Transfer agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Runbooks & Knowledge Transfer Supervisor Inspection Report
