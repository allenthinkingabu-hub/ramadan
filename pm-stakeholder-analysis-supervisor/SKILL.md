---
name: pm-stakeholder-analysis-supervisor
description: "Supervisor inspection skill for pm-stakeholder-analysis. Use when: (1) PM agent completes self-check for task PM-INC-002, (2) SupervisorTriggered event received from pm-stakeholder-analysis skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Stakeholder Analysis — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-INC-002 | Inspection Agent

## Inspection Scope

Independent quality review of the Stakeholder Analysis output for task PM-INC-002. This supervisor:
- Operates independently from the PM Stakeholder Analysis agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Stakeholder Analysis agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Stakeholder Analysis agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Stakeholder Analysis Supervisor Inspection Report
