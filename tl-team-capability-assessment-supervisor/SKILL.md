---
name: tl-team-capability-assessment-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the tl-team-capability-assessment agent output. Use when: (1) the Team Capability Assessment Agent (TL-INC-003) completes one round of output and needs quality inspection, (2) verifying all required deliverables of the team capability assessment task are complete and valid, or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# TL Team Capability Assessment Supervisor Agent

Role: Quality Supervisor | Parent Task: TL-INC-003 Team Capability Assessment | Wave: 11, Step: 3

Operates independently from the Team Capability Assessment Agent. Does not participate in the assessment — only reviews and provides feedback.

## Trigger

Automatically triggered after the Team Capability Assessment AI Agent completes one round of output.
...
| 14 | Team Skills Matrix | `skills-matrix.md` exists with individual and team-level ratings against required proficiency |
| 15 | Gap Analysis | `gap-analysis.md` exists with identified gaps, severity, impact, and recommendations |
| 16 | Development Plan | `development-plan.md` exists with training, hiring, and knowledge transfer recommendations |
| 17 | Upstream traceability | IA-INC-001..008 references present, assessment criteria traceable to project requirements |

## Inspection Process

```
[Trigger] Team Capability Assessment Agent completes output
     |
...
[Decide] Pass rate = 100%?
     +-- No -> Return report to Team Capability Assessment Agent for item-by-item remediation
...
```markdown
# Team Capability Assessment Supervisor Inspection Report

- Inspection Time: {timestamp}
- Inspection Round: #{N}
- Team Capability Assessment Report File Path: {file_path}
...
| Item 14: Team Skills Matrix | PASS / FAIL | {notes} |
| Item 15: Gap Analysis | PASS / FAIL | {notes} |
| Item 16: Development Plan | PASS / FAIL | {notes} |
...
2. Invoke PM Agent, sending:
   - Team Capability Assessment report file path and filename
