---
name: sa-capacity-planning-supervisor
description: "Supervisor inspection skill for sa-capacity-planning. Use when: (1) SA agent completes self-check for task IA-REL-003, (2) SupervisorTriggered event received from sa-capacity-planning skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Capacity Planning — Supervisor

Role: System Architect Supervisor | Task ID: IA-REL-003 | Inspection Agent

## Inspection Scope

Independent quality review of the Capacity Planning output for task IA-REL-003. This supervisor:
- Operates independently from the SA Capacity Planning agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Capacity Planning agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Capacity Planning agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Capacity Planning Supervisor Inspection Report
