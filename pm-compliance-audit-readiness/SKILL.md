---
name: pm-compliance-audit-readiness
description: "IT Project Manager skill for Ensuring all project documentation, approvals, and sign-offs are complete for governance and audit requirements. Use when: (1) PM assigns task PM-QA-004 via TaskTriggered event, (2) QA phase compliance & audit readiness activities are needed, (3) orchestrating compliance & audit readiness deliverables for downstream team tasks."
---

# PM Compliance & Audit Readiness

Role: IT Project Manager | Task ID: PM-QA-004 | Wave: 1, Step: 4

## Objective

Ensuring all project documentation, approvals, and sign-offs are complete for governance and audit requirements.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-QA-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why compliance & audit readiness is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-compliance-audit-readiness-supervisor`
