---
name: sa-compliance-validation
description: "System Architect skill for Verifying regulatory, privacy, and policy requirements through targeted test cases and evidence collection. Use when: (1) PM assigns task IA-QA-005 via TaskTriggered event, (2) QA phase compliance validation activities are needed, (3) orchestrating compliance validation deliverables for downstream team tasks."
---

# SA Compliance Validation

Role: System Architect | Task ID: IA-QA-005 | Wave: 10, Step: 5

## Objective

Verifying regulatory, privacy, and policy requirements through targeted test cases and evidence collection.

## Upstream Inputs

- **Solutions Architect outputs**: SAD, Integration Architecture, NFR Mapping, Technology Blueprint
- **Previous SA phase outputs**: Completed QA prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- TL-QA-001, TL-QA-002, TL-QA-003, TL-QA-004

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-QA-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why compliance validation is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-compliance-validation-supervisor`
