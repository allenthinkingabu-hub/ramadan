# Definition of Done (DoD) — IA-QA-005 Compliance Validation

Quality gates that must ALL pass for Compliance Validation deliverables to be considered complete.
