# Definition of Ready (DoR) — IA-QA-005 Compliance Validation

Prerequisites that must be satisfied before starting Compliance Validation.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-QA-005/` |
