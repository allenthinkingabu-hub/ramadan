---
name: ipm-requirement-clarification
description: "IT Product Manager skill for Responding to developer and tester queries in real-time. Use when: (1) PM assigns task IPM-DEV-001 via TaskTriggered event, (2) Development phase requirement clarification activities are needed, (3) orchestrating requirement clarification deliverables for downstream team tasks."
---

# IPM Requirement Clarification

Role: IT Product Manager | Task ID: IPM-DEV-001 | Wave: 2, Step: 1

## Objective

Responding to developer and tester queries in real-time.

## Upstream Inputs

- **PM Agent**: Project Charter, Stakeholder Analysis, Resource Plan from Wave 1
- **Previous IPM phase outputs**: Completed Development prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- SM-DEV-001, SM-DEV-002, SM-DEV-003, SM-DEV-004

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why requirement clarification is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-requirement-clarification-supervisor`
