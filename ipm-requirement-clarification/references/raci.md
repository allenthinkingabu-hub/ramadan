# RACI Matrix — IPM-DEV-001 Requirement Clarification
...
| ID | Role | Description |
|----|------|-------------|
| IPM | IT Product Manager | Primary executor; produces and delivers Requirement Clarification outputs |
...
| ID | Task | IPM | PM | SPONSOR | SME | END_USER | ARCHITECT | QA |
|----|------|-----|-----|---------|-----|----------|-----------|-----|
