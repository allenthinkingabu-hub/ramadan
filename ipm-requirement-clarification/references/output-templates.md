# Output Template — IPM-DEV-001 Requirement Clarification

Use this template as the strict structure for all Requirement Clarification deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Requirement Clarification Document |
| Version | {{version_number}} |
| Date | {{date}} |
| Author | IT Product Manager AI Agent |
...
|---------|------|--------|-------------|
| 0.1 | {{date}} | IT Product Manager AI Agent | Initial draft |
...
{{Core content specific to Requirement Clarification. Structure according to the deliverable type.}}
...
| IT Product Manager | AI Agent | _________ | {{date}} |
