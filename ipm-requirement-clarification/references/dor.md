# Definition of Ready (DoR) — IPM-DEV-001 Requirement Clarification

Prerequisites that must be satisfied before starting Requirement Clarification.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-001/` |
