# Definition of Ready (DoR) — PM-DEV-004 Resource Management

Prerequisites that must be satisfied before starting Resource Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-DEV-004/` |
