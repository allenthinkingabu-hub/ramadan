# Standard Operating Procedure (SOP) — PM-INC-001 Project Charter Development

## Overview

Step-by-step process from receiving the Project Charter Development task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-INC-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-project-charter-development-supervisor | Signal sent |
