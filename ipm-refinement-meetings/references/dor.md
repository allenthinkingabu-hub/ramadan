# Definition of Ready (DoR) — IPM-REQ-005 Refinement Meetings

Prerequisites that must be satisfied before starting Refinement Meetings.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-005/` |
