# Output Template — IPM-REQ-005 Refinement Meetings

Use this template as the strict structure for all Refinement Meetings deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Refinement Meetings Document |
...
{{Core content specific to Refinement Meetings. Structure according to the deliverable type.}}
