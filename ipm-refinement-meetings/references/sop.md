# Standard Operating Procedure (SOP) — IPM-REQ-005 Refinement Meetings

## Overview

Step-by-step process from receiving the Refinement Meetings task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REQ-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-refinement-meetings-supervisor | Signal sent |
