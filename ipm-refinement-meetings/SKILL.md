---
name: ipm-refinement-meetings
description: "IT Product Manager skill for Organizing requirement reviews to ensure shared understanding across teams. Use when: (1) PM assigns task IPM-REQ-005 via TaskTriggered event, (2) Requirements phase refinement meetings activities are needed, (3) orchestrating refinement meetings deliverables for downstream team tasks."
---

# IPM Refinement Meetings

Role: IT Product Manager | Task ID: IPM-REQ-005 | Wave: 2, Step: 5

## Objective

Organizing requirement reviews to ensure shared understanding across teams.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why refinement meetings is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-refinement-meetings-supervisor`
