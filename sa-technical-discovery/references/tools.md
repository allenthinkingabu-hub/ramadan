# Tools & MCP Tools — SA-technical-discovery

## Standard Tools

| Tool ID | Tool | Purpose |
|:---|:---|:---|
| TL-001 | Web Search | Research industry practices, technology documentation, best practices |
| TL-002 | Web Fetch | Retrieve detailed documentation from URLs |
...
|:---|:---|:---|
| MCP-001 | Context7 (resolve-library-id + query-docs) | Query up-to-date documentation for any technology or framework discovered |
...
- Use **Web Search** and **Context7** for industry research in Step 3
- Use **Glob/Grep** to inspect existing codebase and infrastructure configs
