# Output Template — IPM-QA-003 Launch Checklist

Use this template as the strict structure for all Launch Checklist deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Launch Checklist Document |
...
{{Core content specific to Launch Checklist. Structure according to the deliverable type.}}
