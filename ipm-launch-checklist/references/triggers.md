# Trigger Configuration — IPM-QA-003 Launch Checklist

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-QA-003 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests launch checklist for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-launch-checklist-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Launch Checklist is finalized (after supervisor approval) |
