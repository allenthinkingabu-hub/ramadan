# Standard Operating Procedure (SOP) — IPM-QA-003 Launch Checklist

## Overview

Step-by-step process from receiving the Launch Checklist task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-QA-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-launch-checklist-supervisor | Signal sent |
