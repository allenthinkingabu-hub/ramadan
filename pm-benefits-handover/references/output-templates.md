# Output Template — PM-REL-005 Benefits Handover

Use this template as the strict structure for all Benefits Handover deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Benefits Handover Document |
...
{{Core content specific to Benefits Handover. Structure according to the deliverable type.}}
