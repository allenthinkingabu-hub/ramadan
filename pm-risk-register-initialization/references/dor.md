# Definition of Ready (DoR) — PM-INC-005 Risk Register Initialization

Prerequisites that must be satisfied before starting Risk Register Initialization.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-INC-005/` |
