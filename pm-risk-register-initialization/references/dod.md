# Definition of Done (DoD) — PM-INC-005 Risk Register Initialization

Quality gates that must ALL pass for Risk Register Initialization deliverables to be considered complete.
