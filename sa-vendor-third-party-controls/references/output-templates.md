# Output Template — IA-REQ-008 Vendor & Third-Party Controls

Use this template as the strict structure for all Vendor & Third-Party Controls deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Vendor & Third-Party Controls Document |
...
{{Core content specific to Vendor & Third-Party Controls. Structure according to the deliverable type.}}
