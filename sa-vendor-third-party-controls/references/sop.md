# Standard Operating Procedure (SOP) — IA-REQ-008 Vendor & Third-Party Controls

## Overview

Step-by-step process from receiving the Vendor & Third-Party Controls task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REQ-008/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-vendor-third-party-controls-supervisor | Signal sent |
