---
name: sa-vendor-third-party-controls
description: "System Architect skill for Specifying integration safeguards, SLAs, and operational models for external services and suppliers. Use when: (1) PM assigns task IA-REQ-008 via TaskTriggered event, (2) Requirements phase vendor & third-party controls activities are needed, (3) orchestrating vendor & third-party controls deliverables for downstream team tasks."
---

# SA Vendor & Third-Party Controls

Role: System Architect | Task ID: IA-REQ-008 | Wave: 10, Step: 8

## Objective

Specifying integration safeguards, SLAs, and operational models for external services and suppliers.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REQ-008/`
...
2. Analyze and summarize understanding of the **task purpose** (why vendor & third-party controls is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-vendor-third-party-controls-supervisor`
