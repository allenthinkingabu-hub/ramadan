# Definition of Done (DoD) — IA-INC-008 Third-Party/Vendor Strategy

Quality gates that must ALL pass for Third-Party/Vendor Strategy deliverables to be considered complete.
