# Standard Operating Procedure (SOP) — IA-INC-008 Third-Party/Vendor Strategy

## Overview

Step-by-step process from receiving the Third-Party/Vendor Strategy task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-INC-008/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-third-party-vendor-strategy-supervisor | Signal sent |
