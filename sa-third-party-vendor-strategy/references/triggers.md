# Trigger Configuration — IA-INC-008 Third-Party/Vendor Strategy

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-INC-008 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests third-party/vendor strategy for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-third-party-vendor-strategy-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Third-Party/Vendor Strategy is finalized (after supervisor approval) |
