---
name: sa-third-party-vendor-strategy
description: "System Architect skill for Assessing SaaS/Cloud vendors, integration fit, contractual constraints, and exit/mitigation options. Use when: (1) PM assigns task IA-INC-008 via TaskTriggered event, (2) Inception phase third-party/vendor strategy activities are needed, (3) orchestrating third-party/vendor strategy deliverables for downstream team tasks."
---

# SA Third-Party/Vendor Strategy

Role: System Architect | Task ID: IA-INC-008 | Wave: 10, Step: 8

## Objective

Assessing SaaS/Cloud vendors, integration fit, contractual constraints, and exit/mitigation options.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-INC-008/`
...
2. Analyze and summarize understanding of the **task purpose** (why third-party/vendor strategy is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-third-party-vendor-strategy-supervisor`
