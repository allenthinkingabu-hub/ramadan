# Standard Operating Procedure (SOP) — IPM-DEV-002 Acceptance Criteria

## Overview

Step-by-step process from receiving the Acceptance Criteria task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-DEV-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-acceptance-criteria-supervisor | Signal sent |
