# Definition of Ready (DoR) — IPM-DEV-002 Acceptance Criteria

Prerequisites that must be satisfied before starting Acceptance Criteria.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-002/` |
