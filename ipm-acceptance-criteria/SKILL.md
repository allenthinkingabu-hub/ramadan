---
name: ipm-acceptance-criteria
description: "IT Product Manager skill for Defining the specific conditions that must be met for each feature. Use when: (1) PM assigns task IPM-DEV-002 via TaskTriggered event, (2) Development phase acceptance criteria activities are needed, (3) orchestrating acceptance criteria deliverables for downstream team tasks."
---

# IPM Acceptance Criteria

Role: IT Product Manager | Task ID: IPM-DEV-002 | Wave: 2, Step: 2

## Objective

Defining the specific conditions that must be met for each feature.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why acceptance criteria is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-acceptance-criteria-supervisor`
