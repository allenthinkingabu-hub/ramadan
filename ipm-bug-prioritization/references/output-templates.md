# Output Template — IPM-QA-002 Bug Prioritization

Use this template as the strict structure for all Bug Prioritization deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Bug Prioritization Document |
...
{{Core content specific to Bug Prioritization. Structure according to the deliverable type.}}
