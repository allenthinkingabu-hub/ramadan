---
name: ipm-bug-prioritization
description: "IT Product Manager skill for Deciding which bugs are critical and whether they block release. Use when: (1) PM assigns task IPM-QA-002 via TaskTriggered event, (2) QA phase bug prioritization activities are needed, (3) orchestrating bug prioritization deliverables for downstream team tasks."
---

# IPM Bug Prioritization

Role: IT Product Manager | Task ID: IPM-QA-002 | Wave: 2, Step: 2

## Objective

Deciding which bugs are critical and whether they block release.

## Upstream Inputs

- **PM Agent**: Project Charter, Stakeholder Analysis, Resource Plan from Wave 1
- **Previous IPM phase outputs**: Completed QA prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- SM-QA-001, SM-QA-002, SM-QA-003

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-QA-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why bug prioritization is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-bug-prioritization-supervisor`
