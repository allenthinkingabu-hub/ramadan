# Standard Operating Procedure (SOP) — PM-QA-001 UAT Coordination

## Overview

Step-by-step process from receiving the UAT Coordination task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-QA-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-uat-coordination-supervisor | Signal sent |
