# Trigger Configuration — PM-QA-001 UAT Coordination

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-QA-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests uat coordination for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-uat-coordination-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that UAT Coordination is finalized (after supervisor approval) |
