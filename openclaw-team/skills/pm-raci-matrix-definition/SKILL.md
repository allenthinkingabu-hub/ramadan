---
name: pm-raci-matrix-definition
description: "IT Project Manager skill for Establishing clear roles and responsibilities across all workstreams using RACI (Responsible, Accountable, Consulted, Informed). Use when: (1) PM assigns task PM-REQ-003 via TaskTriggered event, (2) Requirements phase raci matrix definition activities are needed, (3) orchestrating raci matrix definition deliverables for downstream team tasks."
---

# PM RACI Matrix Definition

Role: IT Project Manager | Task ID: PM-REQ-003 | Wave: 1, Step: 3

## Objective

Establishing clear roles and responsibilities across all workstreams using RACI (Responsible, Accountable, Consulted, Informed).
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REQ-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why raci matrix definition is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-raci-matrix-definition-supervisor`
