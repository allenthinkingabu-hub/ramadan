# Standard Operating Procedure (SOP) — PM-REQ-003 RACI Matrix Definition

## Overview

Step-by-step process from receiving the RACI Matrix Definition task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REQ-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-raci-matrix-definition-supervisor | Signal sent |
