# Definition of Ready (DoR) — PM-REQ-003 RACI Matrix Definition

Prerequisites that must be satisfied before starting RACI Matrix Definition.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REQ-003/` |
