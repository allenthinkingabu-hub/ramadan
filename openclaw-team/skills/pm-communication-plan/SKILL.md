---
name: pm-communication-plan
description: "IT Project Manager skill for Defining reporting cadence, meeting schedules, escalation paths, and communication channels for all stakeholders. Use when: (1) PM assigns task PM-REQ-004 via TaskTriggered event, (2) Requirements phase communication plan activities are needed, (3) orchestrating communication plan deliverables for downstream team tasks."
---

# PM Communication Plan

Role: IT Project Manager | Task ID: PM-REQ-004 | Wave: 1, Step: 4

## Objective

Defining reporting cadence, meeting schedules, escalation paths, and communication channels for all stakeholders.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REQ-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why communication plan is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-communication-plan-supervisor`
