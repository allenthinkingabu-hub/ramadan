# Output Template — PM-REQ-004 Communication Plan

Use this template as the strict structure for all Communication Plan deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Communication Plan Document |
...
{{Core content specific to Communication Plan. Structure according to the deliverable type.}}
