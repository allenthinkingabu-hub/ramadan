---
name: sa-infrastructure-validation
description: "System Architect skill for Verifying that deployment environments match the designed architecture specifications. Use when: (1) PM assigns task IA-QA-003 via TaskTriggered event, (2) QA phase infrastructure validation activities are needed, (3) orchestrating infrastructure validation deliverables for downstream team tasks."
---

# SA Infrastructure Validation

Role: System Architect | Task ID: IA-QA-003 | Wave: 10, Step: 3

## Objective

Verifying that deployment environments match the designed architecture specifications.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-QA-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why infrastructure validation is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-infrastructure-validation-supervisor`
