# Standard Operating Procedure (SOP) — IA-QA-003 Infrastructure Validation

## Overview

Step-by-step process from receiving the Infrastructure Validation task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-QA-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-infrastructure-validation-supervisor | Signal sent |
