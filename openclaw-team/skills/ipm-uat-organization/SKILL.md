---
name: ipm-uat-organization
description: "IT Product Manager skill for Coordinating User Acceptance Testing with users/business owners. Use when: (1) PM assigns task IPM-QA-001 via TaskTriggered event, (2) QA phase uat organization activities are needed, (3) orchestrating uat organization deliverables for downstream team tasks."
---

# IPM UAT Organization

Role: IT Product Manager | Task ID: IPM-QA-001 | Wave: 2, Step: 1

## Objective

Coordinating User Acceptance Testing with users/business owners.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-QA-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why uat organization is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-uat-organization-supervisor`
