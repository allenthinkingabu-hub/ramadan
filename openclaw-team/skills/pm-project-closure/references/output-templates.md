# Output Template — PM-REL-003 Project Closure

Use this template as the strict structure for all Project Closure deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Project Closure Document |
...
{{Core content specific to Project Closure. Structure according to the deliverable type.}}
