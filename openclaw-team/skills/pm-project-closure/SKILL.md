...
description: "IT Project Manager skill for Conducting formal project closure including final sign-offs, budget reconciliation, and contract closeouts. Use when: (1) PM assigns task PM-REL-003 via TaskTriggered event, (2) Release phase project closure activities are needed, (3) orchestrating project closure deliverables for downstream team tasks."
---

# PM Project Closure

Role: IT Project Manager | Task ID: PM-REL-003 | Wave: 1, Step: 3

## Objective

Conducting formal project closure including final sign-offs, budget reconciliation, and contract closeouts.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REL-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why project closure is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-project-closure-supervisor`
