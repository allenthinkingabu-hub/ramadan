---
name: sa-compliance-privacy-scan
description: "System Architect skill for Highlighting regulatory or policy constraints (PII/PHI, data residency, industry standards) that shape solution boundaries. Use when: (1) PM assigns task IA-INC-007 via TaskTriggered event, (2) Inception phase compliance & privacy scan activities are needed, (3) orchestrating compliance & privacy scan deliverables for downstream team tasks."
---

# SA Compliance & Privacy Scan

Role: System Architect | Task ID: IA-INC-007 | Wave: 10, Step: 7

## Objective

Highlighting regulatory or policy constraints (PII/PHI, data residency, industry standards) that shape solution boundaries.
...
- TL-INC-001, TL-INC-002, TL-INC-003, TL-INC-004, TL-INC-005

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-INC-007/`
...
2. Analyze and summarize understanding of the **task purpose** (why compliance & privacy scan is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-compliance-privacy-scan-supervisor`
