# Standard Operating Procedure (SOP) — IA-INC-007 Compliance & Privacy Scan

## Overview

Step-by-step process from receiving the Compliance & Privacy Scan task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-INC-007/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-compliance-privacy-scan-supervisor | Signal sent |
