# Definition of Ready (DoR) — IA-INC-007 Compliance & Privacy Scan

Prerequisites that must be satisfied before starting Compliance & Privacy Scan.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-INC-007/` |
