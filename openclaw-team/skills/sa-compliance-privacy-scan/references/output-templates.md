# Output Template — IA-INC-007 Compliance & Privacy Scan

Use this template as the strict structure for all Compliance & Privacy Scan deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Compliance & Privacy Scan Document |
...
{{Core content specific to Compliance & Privacy Scan. Structure according to the deliverable type.}}
