# Definition of Ready (DoR) -- sa-cost-estimation-support
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or system to estimate costs for |
| DoR-02 | Scope is defined or definable | Yes | Estimation scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `cost-estimation/` |
