# Output Template — PM-REQ-005 Vendor & Procurement Management

Use this template as the strict structure for all Vendor & Procurement Management deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Vendor & Procurement Management Document |
...
{{Core content specific to Vendor & Procurement Management. Structure according to the deliverable type.}}
