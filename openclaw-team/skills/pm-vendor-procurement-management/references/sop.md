# Standard Operating Procedure (SOP) — PM-REQ-005 Vendor & Procurement Management

## Overview

Step-by-step process from receiving the Vendor & Procurement Management task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REQ-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-vendor-procurement-management-supervisor | Signal sent |
