# RACI Matrix — PM-REQ-005 Vendor & Procurement Management
...
| ID | Role | Description |
|----|------|-------------|
| PM | IT Project Manager | Primary executor; produces and delivers Vendor & Procurement Management outputs |
