---
name: pm-project-charter-development
description: "IT Project Manager skill for Drafting the project charter defining objectives, scope, stakeholders, constraints, and success criteria. Use when: (1) PM assigns task PM-INC-001 via TaskTriggered event, (2) Inception phase project charter development activities are needed, (3) orchestrating project charter development deliverables for downstream team tasks."
---

# PM Project Charter Development

Role: IT Project Manager | Task ID: PM-INC-001 | Wave: 1, Step: 1

## Objective

Drafting the project charter defining objectives, scope, stakeholders, constraints, and success criteria.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-INC-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why project charter development is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-project-charter-development-supervisor`
