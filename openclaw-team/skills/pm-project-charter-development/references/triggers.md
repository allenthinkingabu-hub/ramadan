# Trigger Configuration — PM-INC-001 Project Charter Development

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-INC-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests project charter development for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-project-charter-development-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Project Charter Development is finalized (after supervisor approval) |
