# Definition of Ready (DoR) — PM-INC-001 Project Charter Development

Prerequisites that must be satisfied before starting Project Charter Development.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-INC-001/` |
