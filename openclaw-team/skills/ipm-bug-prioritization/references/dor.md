# Definition of Ready (DoR) — IPM-QA-002 Bug Prioritization

Prerequisites that must be satisfied before starting Bug Prioritization.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-QA-002/` |
