# Standard Operating Procedure (SOP) — IPM-QA-002 Bug Prioritization

## Overview

Step-by-step process from receiving the Bug Prioritization task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-QA-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-bug-prioritization-supervisor | Signal sent |
