# Inspection Criteria — sa-non-functional-requirements-supervisor

## Detailed Verification Criteria

### Item 1: Trigger Mechanism Config
- **File**: `non-functional-requirements/config/triggers.yaml`
- **Checks**:
  - File exists and is valid YAML
  - Contains at least one trigger event definition
  - Each trigger has: id, event, source, condition fields
  - Metadata section includes task_id "IA-REQ-002"

### Item 2: RACI Matrix Config
- **File**: `non-functional-requirements/config/raci.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/config/skills.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/config/knowledge-domains.yaml`
- **Checks**:
  - File exists and is valid YAML
...
### Item 5: Tools List
- **File**: `non-functional-requirements/config/tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/config/mcp-tools.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **Files**: `non-functional-requirements/config/outputs.yaml` + `non-functional-requirements/templates/`
- **Checks**:
...
- **File**: `non-functional-requirements/config/sop.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/config/dod.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/config/dor.yaml`
- **Checks**:
  - File exists and is valid YAML
...
- **File**: `non-functional-requirements/conversation-log.md`
- **Checks**:
...
### Item 12: Work Log
- **File**: `non-functional-requirements/work-log.md`
- **Checks**:
  - File exists and is non-empty
...
- **Checks**:
  ...
  - NFR specification report exists and covers all required NFR categories
