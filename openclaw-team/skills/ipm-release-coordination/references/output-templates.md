# Output Template — IPM-REL-001 Release Coordination

Use this template as the strict structure for all Release Coordination deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Release Coordination Document |
...
{{Core content specific to Release Coordination. Structure according to the deliverable type.}}
