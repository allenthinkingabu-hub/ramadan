# Standard Operating Procedure (SOP) — IPM-REL-001 Release Coordination

## Overview

Step-by-step process from receiving the Release Coordination task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REL-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-release-coordination-supervisor | Signal sent |
