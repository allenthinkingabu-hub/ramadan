# Definition of Ready (DoR) — IPM-REL-001 Release Coordination

Prerequisites that must be satisfied before starting Release Coordination.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REL-001/` |
