# Trigger Configuration — IPM-REL-001 Release Coordination

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REL-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests release coordination for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-release-coordination-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Release Coordination is finalized (after supervisor approval) |
