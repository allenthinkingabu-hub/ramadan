#!/usr/bin/env python3
"""DoD Self-Verification Script for sa-data-architecture Agent.

Checks all DoD items and reports pass/fail status.

Usage:
    python3 verify_dod.py <data-architecture-dir>

Example:
    python3 verify_dod.py ./data-architecture
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 verify_dod.py <data-architecture-dir>")
        sys.exit(1)
    ...
    results.append(("DoD-14", "Data Architecture report", *check_md_file(base / "data-architecture-report.md")))
    ...
    results.append(("DoD-17", "Data model diagrams", *check_directory(base / "diagrams", min_files=2)))
    results.append(("DoD-18", "Data integration view", *check_md_file(base / "diagrams" / "data-integration-view.md")))
    ...
    print(f"\n{'='*70}")
    print(f"DoD Verification Report -- Data Architecture (IA-REQ-004)")
