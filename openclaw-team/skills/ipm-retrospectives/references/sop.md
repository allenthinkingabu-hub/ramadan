# Standard Operating Procedure (SOP) — IPM-REL-004 Retrospectives

## Overview

Step-by-step process from receiving the Retrospectives task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REL-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-retrospectives-supervisor | Signal sent |
