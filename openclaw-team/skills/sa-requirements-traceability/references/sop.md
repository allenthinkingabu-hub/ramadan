# Standard Operating Procedure (SOP) — IA-REQ-009 Requirements Traceability & Compliance Mapping

## Overview

Step-by-step process from receiving the Requirements Traceability & Compliance Mapping task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REQ-009/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-requirements-traceability-supervisor | Signal sent |
