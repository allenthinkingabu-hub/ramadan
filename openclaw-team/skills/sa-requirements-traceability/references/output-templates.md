# Output Template — IA-REQ-009 Requirements Traceability & Compliance Mapping

Use this template as the strict structure for all Requirements Traceability & Compliance Mapping deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Requirements Traceability & Compliance Mapping Document |
...
|---------|------|--------|-------------|
| 0.1 | {{date}} | System Architect AI Agent | Initial draft |
...
{{Core content specific to Requirements Traceability & Compliance Mapping. Structure according to the deliverable type.}}
...
| System Architect | AI Agent | _________ | {{date}} |
