---
name: sa-requirements-traceability
description: "System Architect skill for Maintaining bidirectional traceability from business/NFR items to design, tests, and runbooks, including privacy and regulatory clauses. Use when: (1) PM assigns task IA-REQ-009 via TaskTriggered event, (2) Requirements phase requirements traceability & compliance mapping activities are needed, (3) orchestrating requirements traceability & compliance mapping deliverables for downstream team tasks."
---

# SA Requirements Traceability & Compliance Mapping

Role: System Architect | Task ID: IA-REQ-009 | Wave: 10, Step: 9

## Objective

Maintaining bidirectional traceability from business/NFR items to design, tests, and runbooks, including privacy and regulatory clauses.

## Upstream Inputs

- **Solutions Architect outputs**: SAD, Integration Architecture, NFR Mapping, Technology Blueprint
- **Previous SA phase outputs**: Completed Requirements prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- TL-REQ-001, TL-REQ-002, TL-REQ-003, TL-REQ-004, TL-REQ-005

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REQ-009/`
...
2. Analyze and summarize understanding of the **task purpose** (why requirements traceability & compliance mapping is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-requirements-traceability-supervisor`
