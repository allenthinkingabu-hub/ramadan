---
name: ipm-data-analysis-supervisor
description: "Supervisor inspection skill for ipm-data-analysis. Use when: (1) IPM agent completes self-check for task IPM-REL-002, (2) SupervisorTriggered event received from ipm-data-analysis skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# IPM Data Analysis — Supervisor

Role: IT Product Manager Supervisor | Task ID: IPM-REL-002 | Inspection Agent

## Inspection Scope

Independent quality review of the Data Analysis output for task IPM-REL-002. This supervisor:
- Operates independently from the IPM Data Analysis agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the IPM Data Analysis agent sends SupervisorTriggered event with:
...
```
[Trigger] IPM Data Analysis agent sends SupervisorTriggered
     |
     v
...
```markdown
# IPM Data Analysis Supervisor Inspection Report
