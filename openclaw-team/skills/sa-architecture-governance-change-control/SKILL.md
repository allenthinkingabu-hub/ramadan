---
name: sa-architecture-governance-change-control
description: "System Architect skill for Setting review cadences, change-control workflows, and ADR audits to keep the architecture baseline governed and current. Use when: (1) PM assigns task IA-REL-009 via TaskTriggered event, (2) Release phase architecture governance & change control activities are needed, (3) orchestrating architecture governance & change control deliverables for downstream team tasks."
---

# SA Architecture Governance & Change Control

Role: System Architect | Task ID: IA-REL-009 | Wave: 10, Step: 9

## Objective

Setting review cadences, change-control workflows, and ADR audits to keep the architecture baseline governed and current.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-009/`
...
2. Analyze and summarize understanding of the **task purpose** (why architecture governance & change control is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-architecture-governance-change-control-supervisor`
