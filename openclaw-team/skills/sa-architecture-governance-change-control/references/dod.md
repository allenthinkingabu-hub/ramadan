# Definition of Done (DoD) — IA-REL-009 Architecture Governance & Change Control

Quality gates that must ALL pass for Architecture Governance & Change Control deliverables to be considered complete.
