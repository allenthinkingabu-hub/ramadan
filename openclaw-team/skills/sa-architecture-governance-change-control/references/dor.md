# Definition of Ready (DoR) — IA-REL-009 Architecture Governance & Change Control

Prerequisites that must be satisfied before starting Architecture Governance & Change Control.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-009/` |
