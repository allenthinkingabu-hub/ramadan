# Output Template — IPM-REQ-002 User Story Decomposition

Use this template as the strict structure for all User Story Decomposition deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — User Story Decomposition Document |
...
{{Core content specific to User Story Decomposition. Structure according to the deliverable type.}}
