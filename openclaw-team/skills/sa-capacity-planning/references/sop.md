# Standard Operating Procedure (SOP) — IA-REL-003 Capacity Planning

## Overview

Step-by-step process from receiving the Capacity Planning task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-capacity-planning-supervisor | Signal sent |
