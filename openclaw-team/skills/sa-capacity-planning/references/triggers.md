# Trigger Configuration — IA-REL-003 Capacity Planning

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-REL-003 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests capacity planning for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-capacity-planning-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Capacity Planning is finalized (after supervisor approval) |
