# Definition of Ready (DoR) — IA-REL-003 Capacity Planning

Prerequisites that must be satisfied before starting Capacity Planning.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-003/` |
