# Output Template — IA-REL-003 Capacity Planning

Use this template as the strict structure for all Capacity Planning deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Capacity Planning Document |
...
{{Core content specific to Capacity Planning. Structure according to the deliverable type.}}
