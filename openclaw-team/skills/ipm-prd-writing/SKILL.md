---
name: ipm-prd-writing
description: "IT Product Manager skill for Creating the Product Requirement Document with detailed logic, boundaries, and interactions. Use when: (1) PM assigns task IPM-REQ-001 via TaskTriggered event, (2) Requirements phase prd writing activities are needed, (3) orchestrating prd writing deliverables for downstream team tasks."
---

# IPM PRD Writing

Role: IT Product Manager | Task ID: IPM-REQ-001 | Wave: 2, Step: 1

## Objective

Creating the Product Requirement Document with detailed logic, boundaries, and interactions.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why prd writing is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-prd-writing-supervisor`
