# Standard Operating Procedure (SOP) — IPM-REQ-001 PRD Writing

## Overview

Step-by-step process from receiving the PRD Writing task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REQ-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-prd-writing-supervisor | Signal sent |
