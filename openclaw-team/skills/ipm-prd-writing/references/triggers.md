# Trigger Configuration — IPM-REQ-001 PRD Writing

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REQ-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests prd writing for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-prd-writing-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that PRD Writing is finalized (after supervisor approval) |
