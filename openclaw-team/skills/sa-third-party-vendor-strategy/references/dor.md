# Definition of Ready (DoR) — IA-INC-008 Third-Party/Vendor Strategy

Prerequisites that must be satisfied before starting Third-Party/Vendor Strategy.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-INC-008/` |
