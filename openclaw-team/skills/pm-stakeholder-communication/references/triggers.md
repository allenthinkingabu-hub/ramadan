# Trigger Configuration — PM-DEV-005 Stakeholder Communication

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-DEV-005 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests stakeholder communication for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-stakeholder-communication-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Stakeholder Communication is finalized (after supervisor approval) |
