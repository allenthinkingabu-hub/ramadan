# Definition of Ready (DoR) — PM-DEV-005 Stakeholder Communication

Prerequisites that must be satisfied before starting Stakeholder Communication.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-DEV-005/` |
