...
description: "IT Project Manager skill for Conducting regular status meetings, steering committee updates, and executive briefings to maintain alignment. Use when: (1) PM assigns task PM-DEV-005 via TaskTriggered event, (2) Development phase stakeholder communication activities are needed, (3) orchestrating stakeholder communication deliverables for downstream team tasks."
---

# PM Stakeholder Communication

Role: IT Project Manager | Task ID: PM-DEV-005 | Wave: 1, Step: 5

## Objective

Conducting regular status meetings, steering committee updates, and executive briefings to maintain alignment.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-DEV-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why stakeholder communication is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-stakeholder-communication-supervisor`
