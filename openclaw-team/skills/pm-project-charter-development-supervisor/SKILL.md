---
name: pm-project-charter-development-supervisor
description: "Supervisor inspection skill for pm-project-charter-development. Use when: (1) PM agent completes self-check for task PM-INC-001, (2) SupervisorTriggered event received from pm-project-charter-development skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Project Charter Development — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-INC-001 | Inspection Agent

## Inspection Scope

Independent quality review of the Project Charter Development output for task PM-INC-001. This supervisor:
- Operates independently from the PM Project Charter Development agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Project Charter Development agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Project Charter Development agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Project Charter Development Supervisor Inspection Report
