---
name: pm-progress-tracking-reporting-supervisor
description: "Supervisor inspection skill for pm-progress-tracking-reporting. Use when: (1) PM agent completes self-check for task PM-DEV-001, (2) SupervisorTriggered event received from pm-progress-tracking-reporting skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Progress Tracking & Reporting — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-DEV-001 | Inspection Agent

## Inspection Scope

Independent quality review of the Progress Tracking & Reporting output for task PM-DEV-001. This supervisor:
- Operates independently from the PM Progress Tracking & Reporting agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Progress Tracking & Reporting agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Progress Tracking & Reporting agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Progress Tracking & Reporting Supervisor Inspection Report
