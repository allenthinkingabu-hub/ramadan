---
name: pm-risk-register-initialization
description: "IT Project Manager skill for Identifying early project risks, assessing probability and impact, and defining initial mitigation strategies. Use when: (1) PM assigns task PM-INC-005 via TaskTriggered event, (2) Inception phase risk register initialization activities are needed, (3) orchestrating risk register initialization deliverables for downstream team tasks."
---

# PM Risk Register Initialization

Role: IT Project Manager | Task ID: PM-INC-005 | Wave: 1, Step: 5

## Objective

Identifying early project risks, assessing probability and impact, and defining initial mitigation strategies.
...
- IPM-INC-001, IPM-INC-002, IPM-INC-003, IPM-INC-004, IPM-INC-005

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-INC-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why risk register initialization is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-risk-register-initialization-supervisor`
