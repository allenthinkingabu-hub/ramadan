# Standard Operating Procedure (SOP) — PM-INC-005 Risk Register Initialization

## Overview

Step-by-step process from receiving the Risk Register Initialization task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-INC-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-risk-register-initialization-supervisor | Signal sent |
