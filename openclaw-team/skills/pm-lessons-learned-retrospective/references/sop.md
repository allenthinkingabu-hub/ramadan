# Standard Operating Procedure (SOP) — PM-REL-004 Lessons Learned & Retrospective

## Overview

Step-by-step process from receiving the Lessons Learned & Retrospective task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REL-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-lessons-learned-retrospective-supervisor | Signal sent |
