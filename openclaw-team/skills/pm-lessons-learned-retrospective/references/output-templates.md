# Output Template — PM-REL-004 Lessons Learned & Retrospective

Use this template as the strict structure for all Lessons Learned & Retrospective deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Lessons Learned & Retrospective Document |
...
{{Core content specific to Lessons Learned & Retrospective. Structure according to the deliverable type.}}
