# Definition of Ready (DoR) — PM-QA-004 Compliance & Audit Readiness

Prerequisites that must be satisfied before starting Compliance & Audit Readiness.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-QA-004/` |
