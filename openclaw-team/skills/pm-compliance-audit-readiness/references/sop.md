# Standard Operating Procedure (SOP) — PM-QA-004 Compliance & Audit Readiness

## Overview

Step-by-step process from receiving the Compliance & Audit Readiness task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-QA-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-compliance-audit-readiness-supervisor | Signal sent |
