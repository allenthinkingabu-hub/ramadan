# Definition of Done (DoD) — PM-QA-004 Compliance & Audit Readiness

Quality gates that must ALL pass for Compliance & Audit Readiness deliverables to be considered complete.
