# Output Template — PM-QA-004 Compliance & Audit Readiness

Use this template as the strict structure for all Compliance & Audit Readiness deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Compliance & Audit Readiness Document |
...
{{Core content specific to Compliance & Audit Readiness. Structure according to the deliverable type.}}
