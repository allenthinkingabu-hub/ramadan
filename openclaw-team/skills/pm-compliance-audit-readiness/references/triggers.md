# Trigger Configuration — PM-QA-004 Compliance & Audit Readiness

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-QA-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests compliance & audit readiness for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-compliance-audit-readiness-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Compliance & Audit Readiness is finalized (after supervisor approval) |
