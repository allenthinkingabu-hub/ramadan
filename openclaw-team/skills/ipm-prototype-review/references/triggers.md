# Trigger Configuration — IPM-REQ-004 Prototype Review

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REQ-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests prototype review for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-prototype-review-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Prototype Review is finalized (after supervisor approval) |
