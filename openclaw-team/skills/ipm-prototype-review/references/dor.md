# Definition of Ready (DoR) — IPM-REQ-004 Prototype Review

Prerequisites that must be satisfied before starting Prototype Review.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-004/` |
