# Definition of Ready (DoR) — IA-REL-002 Monitoring & Observability

Prerequisites that must be satisfied before starting Monitoring & Observability.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-002/` |
