# Output Template — IA-REL-002 Monitoring & Observability

Use this template as the strict structure for all Monitoring & Observability deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Monitoring & Observability Document |
...
{{Core content specific to Monitoring & Observability. Structure according to the deliverable type.}}
