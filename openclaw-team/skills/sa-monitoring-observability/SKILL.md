---
name: sa-monitoring-observability
description: "System Architect skill for Setting up logging, metrics, alerting, and distributed tracing for production systems. Use when: (1) PM assigns task IA-REL-002 via TaskTriggered event, (2) Release phase monitoring & observability activities are needed, (3) orchestrating monitoring & observability deliverables for downstream team tasks."
---

# SA Monitoring & Observability

Role: System Architect | Task ID: IA-REL-002 | Wave: 10, Step: 2

## Objective

Setting up logging, metrics, alerting, and distributed tracing for production systems.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why monitoring & observability is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-monitoring-observability-supervisor`
