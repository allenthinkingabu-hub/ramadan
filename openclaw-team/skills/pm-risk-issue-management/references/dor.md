# Definition of Ready (DoR) — PM-DEV-002 Risk & Issue Management

Prerequisites that must be satisfied before starting Risk & Issue Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-DEV-002/` |
