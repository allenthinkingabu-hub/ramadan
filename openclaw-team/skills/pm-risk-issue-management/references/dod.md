# Definition of Done (DoD) — PM-DEV-002 Risk & Issue Management

Quality gates that must ALL pass for Risk & Issue Management deliverables to be considered complete.
