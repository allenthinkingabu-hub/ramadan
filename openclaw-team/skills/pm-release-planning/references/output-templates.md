# Output Template — PM-QA-003 Release Planning

Use this template as the strict structure for all Release Planning deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Release Planning Document |
...
{{Core content specific to Release Planning. Structure according to the deliverable type.}}
