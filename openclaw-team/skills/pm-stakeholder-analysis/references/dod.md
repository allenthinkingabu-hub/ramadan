# Definition of Done (DoD) — PM-INC-002 Stakeholder Analysis

Quality gates that must ALL pass for Stakeholder Analysis deliverables to be considered complete.
