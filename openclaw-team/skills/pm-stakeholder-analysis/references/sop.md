# Standard Operating Procedure (SOP) — PM-INC-002 Stakeholder Analysis

## Overview

Step-by-step process from receiving the Stakeholder Analysis task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-INC-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-stakeholder-analysis-supervisor | Signal sent |
