---
name: pm-stakeholder-analysis
description: "IT Project Manager skill for Identifying stakeholders, assessing their influence and interest, and developing a stakeholder engagement plan. Use when: (1) PM assigns task PM-INC-002 via TaskTriggered event, (2) Inception phase stakeholder analysis activities are needed, (3) orchestrating stakeholder analysis deliverables for downstream team tasks."
---

# PM Stakeholder Analysis

Role: IT Project Manager | Task ID: PM-INC-002 | Wave: 1, Step: 2

## Objective

Identifying stakeholders, assessing their influence and interest, and developing a stakeholder engagement plan.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-INC-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why stakeholder analysis is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-stakeholder-analysis-supervisor`
