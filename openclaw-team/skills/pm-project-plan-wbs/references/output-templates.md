# Output Template — PM-REQ-001 Project Plan & WBS

Use this template as the strict structure for all Project Plan & WBS deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Project Plan & WBS Document |
...
{{Core content specific to Project Plan & WBS. Structure according to the deliverable type.}}
