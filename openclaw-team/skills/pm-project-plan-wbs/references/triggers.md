# Trigger Configuration — PM-REQ-001 Project Plan & WBS

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REQ-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests project plan & wbs for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-project-plan-wbs-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Project Plan & WBS is finalized (after supervisor approval) |
