# Definition of Ready (DoR) — IPM-QA-003 Launch Checklist

Prerequisites that must be satisfied before starting Launch Checklist.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-QA-003/` |
