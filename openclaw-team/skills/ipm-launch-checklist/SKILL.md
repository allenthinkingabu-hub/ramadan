---
name: ipm-launch-checklist
description: "IT Product Manager skill for Confirming release standards (Definition of Done - DoD). Use when: (1) PM assigns task IPM-QA-003 via TaskTriggered event, (2) QA phase launch checklist activities are needed, (3) orchestrating launch checklist deliverables for downstream team tasks."
---

# IPM Launch Checklist

Role: IT Product Manager | Task ID: IPM-QA-003 | Wave: 2, Step: 3

## Objective

Confirming release standards (Definition of Done - DoD).
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-QA-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why launch checklist is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-launch-checklist-supervisor`
