---
name: pm-go-live-coordination
description: "IT Project Manager skill for Orchestrating the production launch across development, operations, support, and business teams. Use when: (1) PM assigns task PM-REL-001 via TaskTriggered event, (2) Release phase go-live coordination activities are needed, (3) orchestrating go-live coordination deliverables for downstream team tasks."
---

# PM Go-Live Coordination

Role: IT Project Manager | Task ID: PM-REL-001 | Wave: 1, Step: 1

## Objective

Orchestrating the production launch across development, operations, support, and business teams.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REL-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why go-live coordination is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-go-live-coordination-supervisor`
