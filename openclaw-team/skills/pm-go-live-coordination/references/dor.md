# Definition of Ready (DoR) — PM-REL-001 Go-Live Coordination

Prerequisites that must be satisfied before starting Go-Live Coordination.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REL-001/` |
