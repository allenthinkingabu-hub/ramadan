---
name: pm-benefits-handover
description: "IT Project Manager skill for Transitioning project deliverables to operations and business owners with documented support and maintenance plans. Use when: (1) PM assigns task PM-REL-005 via TaskTriggered event, (2) Release phase benefits handover activities are needed, (3) orchestrating benefits handover deliverables for downstream team tasks."
---

# PM Benefits Handover

Role: IT Project Manager | Task ID: PM-REL-005 | Wave: 1, Step: 5

## Objective

Transitioning project deliverables to operations and business owners with documented support and maintenance plans.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REL-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why benefits handover is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-benefits-handover-supervisor`
