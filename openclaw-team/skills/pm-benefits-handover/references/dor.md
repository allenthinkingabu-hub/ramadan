# Definition of Ready (DoR) — PM-REL-005 Benefits Handover

Prerequisites that must be satisfied before starting Benefits Handover.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REL-005/` |
