# Definition of Ready (DoR) — IA-REL-001 Deployment Architecture

Prerequisites that must be satisfied before starting Deployment Architecture.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-001/` |
