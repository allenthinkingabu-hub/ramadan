---
name: sa-data-privacy-governance-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the sa-data-privacy-governance agent output. Use when: (1) the Data Privacy & Governance Agent (IA-REQ-006) completes one round of output and needs quality inspection, (2) verifying all required deliverables of the data privacy governance task are complete and valid (including regulatory compliance view and NFR alignment note), or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# SA Data Privacy & Governance Supervisor Agent

Role: Quality Supervisor | Parent Task: IA-REQ-006 Data Privacy & Governance | Wave: 10, Step: 6

Operates independently from the Data Privacy & Governance Agent. Does not participate in the design -- only reviews and provides feedback.

## Trigger

Automatically triggered after the Data Privacy & Governance AI Agent completes one round of output.
...
| 14 | Regulatory compliance view | `diagrams/regulatory-compliance-view.md` exists with regulation mapping, PIA, DPA, breach procedures |
| 15 | NFR alignment note | `nfr-alignment.md` exists with NFR mapping, constraints, assumptions, privacy SLO/SLI targets |
| 16 | Governance completeness | Classification taxonomy, retention policy, residency rules, access control model, consent management all covered |
| 17 | Upstream traceability | SA-REQ-001..005 references present, decisions traceable to requirements |

## Inspection Process

```
[Trigger] Data Privacy & Governance Agent completes output
     |
...
[Decide] Pass rate = 100%?
     +-- No -> Return report to Data Privacy & Governance Agent for item-by-item remediation
...
```markdown
# Data Privacy & Governance Supervisor Inspection Report

- Inspection Time: {timestamp}
- Inspection Round: #{N}
- Data Privacy & Governance Report File Path: {file_path}
...
| Item 14: Regulatory Compliance View | PASS / FAIL | {notes} |
| Item 15: NFR Alignment Note | PASS / FAIL | {notes} |
| Item 16: Governance Completeness | PASS / FAIL | {notes} |
...
2. Invoke PM Agent, sending:
   - Data Privacy & Governance report file path and filename
