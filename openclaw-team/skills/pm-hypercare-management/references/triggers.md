# Trigger Configuration — PM-REL-002 Hypercare Management

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REL-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests hypercare management for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-hypercare-management-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Hypercare Management is finalized (after supervisor approval) |
