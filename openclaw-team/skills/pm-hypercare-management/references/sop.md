# Standard Operating Procedure (SOP) — PM-REL-002 Hypercare Management

## Overview

Step-by-step process from receiving the Hypercare Management task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REL-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-hypercare-management-supervisor | Signal sent |
