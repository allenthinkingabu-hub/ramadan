# Definition of Done (DoD) — PM-REL-002 Hypercare Management

Quality gates that must ALL pass for Hypercare Management deliverables to be considered complete.
