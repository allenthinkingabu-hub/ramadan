---
name: ipm-feasibility-assessment-supervisor
description: "Supervisor inspection skill for ipm-feasibility-assessment. Use when: (1) IPM agent completes self-check for task IPM-INC-004, (2) SupervisorTriggered event received from ipm-feasibility-assessment skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# IPM Feasibility Assessment — Supervisor

Role: IT Product Manager Supervisor | Task ID: IPM-INC-004 | Inspection Agent

## Inspection Scope

Independent quality review of the Feasibility Assessment output for task IPM-INC-004. This supervisor:
- Operates independently from the IPM Feasibility Assessment agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the IPM Feasibility Assessment agent sends SupervisorTriggered event with:
...
```
[Trigger] IPM Feasibility Assessment agent sends SupervisorTriggered
     |
     v
...
```markdown
# IPM Feasibility Assessment Supervisor Inspection Report
