# Trigger Configuration — PM-REQ-002 Schedule Development

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REQ-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests schedule development for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-schedule-development-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Schedule Development is finalized (after supervisor approval) |
