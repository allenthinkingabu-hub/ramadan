# Definition of Ready (DoR) — PM-REQ-002 Schedule Development

Prerequisites that must be satisfied before starting Schedule Development.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-REQ-002/` |
