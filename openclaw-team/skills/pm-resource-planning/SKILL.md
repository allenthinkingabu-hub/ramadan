---
name: pm-resource-planning
description: "IT Project Manager skill for Estimating team composition, skillsets, and resource availability needed for project execution. Use when: (1) PM assigns task PM-INC-003 via TaskTriggered event, (2) Inception phase resource planning activities are needed, (3) orchestrating resource planning deliverables for downstream team tasks."
---

# PM Resource Planning

Role: IT Project Manager | Task ID: PM-INC-003 | Wave: 1, Step: 3

## Objective

Estimating team composition, skillsets, and resource availability needed for project execution.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-INC-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why resource planning is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-resource-planning-supervisor`
