# Definition of Ready (DoR) — PM-INC-003 Resource Planning

Prerequisites that must be satisfied before starting Resource Planning.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-INC-003/` |
