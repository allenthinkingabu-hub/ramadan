# Output Template — PM-INC-003 Resource Planning

Use this template as the strict structure for all Resource Planning deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Resource Planning Document |
...
{{Core content specific to Resource Planning. Structure according to the deliverable type.}}
