# Standard Operating Procedure (SOP) — PM-INC-003 Resource Planning

## Overview

Step-by-step process from receiving the Resource Planning task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-INC-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-resource-planning-supervisor | Signal sent |
