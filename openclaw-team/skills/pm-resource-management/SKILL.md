---
name: pm-resource-management
description: "IT Project Manager skill for Balancing team workloads, resolving resource conflicts, and adjusting allocations based on project needs. Use when: (1) PM assigns task PM-DEV-004 via TaskTriggered event, (2) Development phase resource management activities are needed, (3) orchestrating resource management deliverables for downstream team tasks."
---

# PM Resource Management

Role: IT Project Manager | Task ID: PM-DEV-004 | Wave: 1, Step: 4

## Objective

Balancing team workloads, resolving resource conflicts, and adjusting allocations based on project needs.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-DEV-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why resource management is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-resource-management-supervisor`
