# Standard Operating Procedure (SOP) — PM-DEV-004 Resource Management

## Overview

Step-by-step process from receiving the Resource Management task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-DEV-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-resource-management-supervisor | Signal sent |
