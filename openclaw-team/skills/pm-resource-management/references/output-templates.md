# Output Template — PM-DEV-004 Resource Management

Use this template as the strict structure for all Resource Management deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Resource Management Document |
...
{{Core content specific to Resource Management. Structure according to the deliverable type.}}
