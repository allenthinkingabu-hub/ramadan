# Standard Operating Procedure (SOP) — IA-REL-007 FinOps & Cost Guardrails

## Overview

Step-by-step process from receiving the FinOps & Cost Guardrails task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-007/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-finops-cost-guardrails-supervisor | Signal sent |
