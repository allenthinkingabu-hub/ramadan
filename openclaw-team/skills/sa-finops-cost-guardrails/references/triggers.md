# Trigger Configuration — IA-REL-007 FinOps & Cost Guardrails

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-REL-007 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests finops & cost guardrails for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-finops-cost-guardrails-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that FinOps & Cost Guardrails is finalized (after supervisor approval) |
