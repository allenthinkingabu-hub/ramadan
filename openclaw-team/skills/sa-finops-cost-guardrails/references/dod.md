# Definition of Done (DoD) — IA-REL-007 FinOps & Cost Guardrails

Quality gates that must ALL pass for FinOps & Cost Guardrails deliverables to be considered complete.
