---
name: sa-finops-cost-guardrails
description: "System Architect skill for Establishing cost baselines, alerts, and optimization playbooks tied to usage trends. Use when: (1) PM assigns task IA-REL-007 via TaskTriggered event, (2) Release phase finops & cost guardrails activities are needed, (3) orchestrating finops & cost guardrails deliverables for downstream team tasks."
---

# SA FinOps & Cost Guardrails

Role: System Architect | Task ID: IA-REL-007 | Wave: 10, Step: 7

## Objective

Establishing cost baselines, alerts, and optimization playbooks tied to usage trends.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-007/`
...
2. Analyze and summarize understanding of the **task purpose** (why finops & cost guardrails is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-finops-cost-guardrails-supervisor`
