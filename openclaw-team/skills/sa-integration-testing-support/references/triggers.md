# Trigger Configuration — IA-QA-004 Integration Testing Support

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-QA-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests integration testing support for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-integration-testing-support-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Integration Testing Support is finalized (after supervisor approval) |
