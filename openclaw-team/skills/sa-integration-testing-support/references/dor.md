# Definition of Ready (DoR) — IA-QA-004 Integration Testing Support

Prerequisites that must be satisfied before starting Integration Testing Support.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-QA-004/` |
