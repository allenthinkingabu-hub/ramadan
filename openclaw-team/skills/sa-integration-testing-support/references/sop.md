# Standard Operating Procedure (SOP) — IA-QA-004 Integration Testing Support

## Overview

Step-by-step process from receiving the Integration Testing Support task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-QA-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-integration-testing-support-supervisor | Signal sent |
