# Definition of Ready (DoR) — IPM-REL-002 Data Analysis

Prerequisites that must be satisfied before starting Data Analysis.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REL-002/` |
