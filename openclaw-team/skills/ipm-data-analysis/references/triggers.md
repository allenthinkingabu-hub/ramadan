# Trigger Configuration — IPM-REL-002 Data Analysis

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REL-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests data analysis for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-data-analysis-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Data Analysis is finalized (after supervisor approval) |
