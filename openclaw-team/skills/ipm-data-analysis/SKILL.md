---
name: ipm-data-analysis
description: "IT Product Manager skill for Analyzing KPIs after launch to verify if objectives were met. Use when: (1) PM assigns task IPM-REL-002 via TaskTriggered event, (2) Release phase data analysis activities are needed, (3) orchestrating data analysis deliverables for downstream team tasks."
---

# IPM Data Analysis

Role: IT Product Manager | Task ID: IPM-REL-002 | Wave: 2, Step: 2

## Objective

Analyzing KPIs after launch to verify if objectives were met.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REL-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why data analysis is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-data-analysis-supervisor`
