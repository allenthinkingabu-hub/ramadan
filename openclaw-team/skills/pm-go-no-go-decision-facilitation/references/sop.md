# Standard Operating Procedure (SOP) — PM-QA-002 Go/No-Go Decision Facilitation

## Overview

Step-by-step process from receiving the Go/No-Go Decision Facilitation task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-QA-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-go-no-go-decision-facilitation-supervisor | Signal sent |
