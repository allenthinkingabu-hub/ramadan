# Definition of Ready (DoR) — IA-REQ-008 Vendor & Third-Party Controls

Prerequisites that must be satisfied before starting Vendor & Third-Party Controls.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REQ-008/` |
