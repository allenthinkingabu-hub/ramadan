# Standard Operating Procedure (SOP) — IA-QA-005 Compliance Validation

## Overview

Step-by-step process from receiving the Compliance Validation task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-QA-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-compliance-validation-supervisor | Signal sent |
