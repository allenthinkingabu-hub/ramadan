# Output Template — PM-INC-004 Budget Estimation

Use this template as the strict structure for all Budget Estimation deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Budget Estimation Document |
...
{{Core content specific to Budget Estimation. Structure according to the deliverable type.}}
