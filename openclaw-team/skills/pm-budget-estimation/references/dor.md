# Definition of Ready (DoR) — PM-INC-004 Budget Estimation

Prerequisites that must be satisfied before starting Budget Estimation.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-INC-004/` |
