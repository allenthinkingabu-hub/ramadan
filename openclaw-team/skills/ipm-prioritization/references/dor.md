# Definition of Ready (DoR) — IPM-REQ-003 Prioritization

Prerequisites that must be satisfied before starting Prioritization.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-003/` |
