# Standard Operating Procedure (SOP) — IPM-REQ-003 Prioritization

## Overview

Step-by-step process from receiving the Prioritization task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REQ-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-prioritization-supervisor | Signal sent |
