# Trigger Configuration — IPM-REQ-005 Refinement Meetings

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REQ-005 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests refinement meetings for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-refinement-meetings-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Refinement Meetings is finalized (after supervisor approval) |
