# Definition of Ready (DoR) — IPM-REL-003 User Feedback

Prerequisites that must be satisfied before starting User Feedback.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REL-003/` |
