# Output Template — IPM-REL-003 User Feedback

Use this template as the strict structure for all User Feedback deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — User Feedback Document |
...
{{Core content specific to User Feedback. Structure according to the deliverable type.}}
