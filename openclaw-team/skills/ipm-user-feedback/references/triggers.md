# Trigger Configuration — IPM-REL-003 User Feedback

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REL-003 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests user feedback for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-user-feedback-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that User Feedback is finalized (after supervisor approval) |
