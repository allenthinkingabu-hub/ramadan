# Standard Operating Procedure (SOP) — IPM-REL-003 User Feedback

## Overview

Step-by-step process from receiving the User Feedback task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REL-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-user-feedback-supervisor | Signal sent |
