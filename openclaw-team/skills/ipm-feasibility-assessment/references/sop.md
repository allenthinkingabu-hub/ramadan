# Standard Operating Procedure (SOP) — IPM-INC-004 Feasibility Assessment

## Overview

Step-by-step process from receiving the Feasibility Assessment task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-INC-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-feasibility-assessment-supervisor | Signal sent |
