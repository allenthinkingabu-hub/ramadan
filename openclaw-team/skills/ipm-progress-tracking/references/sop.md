# Standard Operating Procedure (SOP) — IPM-DEV-004 Progress Tracking

## Overview

Step-by-step process from receiving the Progress Tracking task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-DEV-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-progress-tracking-supervisor | Signal sent |
