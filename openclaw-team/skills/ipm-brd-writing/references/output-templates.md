# BRD Output Template — IPM-INC-003

Use this template as the strict structure for all BRD documents. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| IT Product Manager | IPM AI Agent | _________ | {date} |
