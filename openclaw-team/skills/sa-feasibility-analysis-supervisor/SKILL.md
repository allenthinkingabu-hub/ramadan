---
name: sa-feasibility-analysis-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the SA-feasibility-analysis agent output. Use when: (1) the Feasibility Analysis Agent (IA-INC-002) completes one round of output and needs quality inspection, (2) verifying all 13 required deliverables of the feasibility analysis task are complete and valid, or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# SA Feasibility Analysis Supervisor Agent

Role: Quality Supervisor | Parent Task: IA-INC-002 Feasibility Analysis

Operates independently from the Feasibility Analysis Agent. Does not participate in the analysis — only reviews and provides feedback.

## Trigger

Automatically triggered after the Feasibility Analysis AI Agent completes one round of output.
