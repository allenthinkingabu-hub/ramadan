---
name: pm-go-live-coordination-supervisor
description: "Supervisor inspection skill for pm-go-live-coordination. Use when: (1) PM agent completes self-check for task PM-REL-001, (2) SupervisorTriggered event received from pm-go-live-coordination skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Go-Live Coordination — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REL-001 | Inspection Agent

## Inspection Scope

Independent quality review of the Go-Live Coordination output for task PM-REL-001. This supervisor:
- Operates independently from the PM Go-Live Coordination agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Go-Live Coordination agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Go-Live Coordination agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Go-Live Coordination Supervisor Inspection Report
