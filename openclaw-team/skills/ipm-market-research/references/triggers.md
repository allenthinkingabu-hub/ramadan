# Trigger Configuration — IPM-INC-002 Market Research

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-INC-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests market research for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-market-research-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Market Research is finalized (after supervisor approval) |
