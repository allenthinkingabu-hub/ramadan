# Standard Operating Procedure (SOP) — IPM-INC-002 Market Research

## Overview

Step-by-step process from receiving the Market Research task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-INC-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-market-research-supervisor | Signal sent |
