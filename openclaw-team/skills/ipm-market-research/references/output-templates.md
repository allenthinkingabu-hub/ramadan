# Output Template — IPM-INC-002 Market Research

Use this template as the strict structure for all Market Research deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Market Research Document |
...
{{Core content specific to Market Research. Structure according to the deliverable type.}}
