---
name: ipm-market-research
description: "IT Product Manager skill for Analyzing competitors, industry trends, and user pain points. Use when: (1) PM assigns task IPM-INC-002 via TaskTriggered event, (2) Inception phase market research activities are needed, (3) orchestrating market research deliverables for downstream team tasks."
---

# IPM Market Research

Role: IT Product Manager | Task ID: IPM-INC-002 | Wave: 2, Step: 2

## Objective

Analyzing competitors, industry trends, and user pain points.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-INC-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why market research is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-market-research-supervisor`
