# Trigger Configuration — IPM-DEV-002 Acceptance Criteria

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-DEV-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests acceptance criteria for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-acceptance-criteria-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Acceptance Criteria is finalized (after supervisor approval) |
