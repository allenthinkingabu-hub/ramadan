# Standard Operating Procedure (SOP) — IPM-DEV-001 Requirement Clarification

## Overview

Step-by-step process from receiving the Requirement Clarification task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-DEV-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-requirement-clarification-supervisor | Signal sent |
