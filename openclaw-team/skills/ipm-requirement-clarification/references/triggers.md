# Trigger Configuration — IPM-DEV-001 Requirement Clarification

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-DEV-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests requirement clarification for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-requirement-clarification-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Requirement Clarification is finalized (after supervisor approval) |
