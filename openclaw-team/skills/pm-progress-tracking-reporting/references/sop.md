# Standard Operating Procedure (SOP) — PM-DEV-001 Progress Tracking & Reporting

## Overview

Step-by-step process from receiving the Progress Tracking & Reporting task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-DEV-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-progress-tracking-reporting-supervisor | Signal sent |
