# Trigger Configuration — PM-DEV-001 Progress Tracking & Reporting

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-DEV-001 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests progress tracking & reporting for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-progress-tracking-reporting-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Progress Tracking & Reporting is finalized (after supervisor approval) |
