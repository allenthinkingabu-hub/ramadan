# Definition of Done (DoD) — PM-DEV-001 Progress Tracking & Reporting

Quality gates that must ALL pass for Progress Tracking & Reporting deliverables to be considered complete.
