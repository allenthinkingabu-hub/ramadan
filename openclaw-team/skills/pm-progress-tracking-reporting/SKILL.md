---
name: pm-progress-tracking-reporting
description: "IT Project Manager skill for Monitoring project health through status reports, dashboards, earned value metrics, and milestone tracking. Use when: (1) PM assigns task PM-DEV-001 via TaskTriggered event, (2) Development phase progress tracking & reporting activities are needed, (3) orchestrating progress tracking & reporting deliverables for downstream team tasks."
---

# PM Progress Tracking & Reporting

Role: IT Project Manager | Task ID: PM-DEV-001 | Wave: 1, Step: 1

## Objective

Monitoring project health through status reports, dashboards, earned value metrics, and milestone tracking.

## Upstream Inputs

- **User / Organization**: Project initiation request and strategic objectives
- **Previous PM phase outputs**: Completed Development prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- IPM-DEV-001, IPM-DEV-002, IPM-DEV-003, IPM-DEV-004

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-DEV-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why progress tracking & reporting is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-progress-tracking-reporting-supervisor`
