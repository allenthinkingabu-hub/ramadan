# RACI Matrix -- Technical Standards (IA-REQ-005)

## Matrix

| Task / Deliverable | IT Architect (SA) | Project Manager (PM) | Business Analyst (BA) | Tech Lead (TL) | Dev Lead (DL) | Security Architect (SecA) |
|:---|:---:|:---:|:---:|:---:|:---:|:---:|
| Define standards scope & objectives | R | A | I | C | C | C |
| Establish coding standards | R | I | I | C | C | I |
| Create design patterns catalog | R | I | I | C | C | I |
| Define architectural guidelines | R | I | I | C | C | C |
| Define error handling standards | R | I | I | C | C | I |
| Define logging & observability standards | R | I | I | C | C | I |
| Define testing standards | R | I | I | C | C | I |
| Define security coding standards | R | I | I | C | C | C |
| Produce standards enforcement view | R | I | I | C | C | C |
| Produce NFR alignment note | R | I | I | C | C | C |
| Produce Technical Standards report | R | A | I | C | C | C |
...
1. Technical Standards report file path
2. This RACI matrix
