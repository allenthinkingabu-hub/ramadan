---
name: sa-resilience-chaos-testing-supervisor
description: "Supervisor inspection skill for sa-resilience-chaos-testing. Use when: (1) SA agent completes self-check for task IA-REL-008, (2) SupervisorTriggered event received from sa-resilience-chaos-testing skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Resilience/Chaos Testing — Supervisor

Role: System Architect Supervisor | Task ID: IA-REL-008 | Inspection Agent

## Inspection Scope

Independent quality review of the Resilience/Chaos Testing output for task IA-REL-008. This supervisor:
- Operates independently from the SA Resilience/Chaos Testing agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Resilience/Chaos Testing agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Resilience/Chaos Testing agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Resilience/Chaos Testing Supervisor Inspection Report
