#!/usr/bin/env python3
"""DoD Self-Verification Script for sa-technology-selection Agent.

Checks all DoD items and reports pass/fail status.

Usage:
    python3 verify_dod.py <technology-selection-dir>

Example:
    python3 verify_dod.py ./technology-selection
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 verify_dod.py <technology-selection-dir>")
        sys.exit(1)
    ...
    results.append(("DoD-14", "Technology Selection report", *check_md_file(base / "technology-selection-report.md")))
    ...
    print(f"\n{'='*70}")
    print(f"DoD Verification Report — Technology Selection (IA-INC-003)")
