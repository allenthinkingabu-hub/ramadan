---
name: sa-runbooks-knowledge-transfer
description: "System Architect skill for Delivering operational runbooks, onboarding material, and handover sessions for support/ops teams. Use when: (1) PM assigns task IA-REL-006 via TaskTriggered event, (2) Release phase runbooks & knowledge transfer activities are needed, (3) orchestrating runbooks & knowledge transfer deliverables for downstream team tasks."
---

# SA Runbooks & Knowledge Transfer

Role: System Architect | Task ID: IA-REL-006 | Wave: 10, Step: 6

## Objective

Delivering operational runbooks, onboarding material, and handover sessions for support/ops teams.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-006/`
...
2. Analyze and summarize understanding of the **task purpose** (why runbooks & knowledge transfer is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-runbooks-knowledge-transfer-supervisor`
