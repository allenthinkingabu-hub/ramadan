# Definition of Ready (DoR) — IA-REL-006 Runbooks & Knowledge Transfer

Prerequisites that must be satisfied before starting Runbooks & Knowledge Transfer.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-006/` |
