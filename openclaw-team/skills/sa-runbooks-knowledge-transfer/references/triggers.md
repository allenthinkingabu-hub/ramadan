# Trigger Configuration — IA-REL-006 Runbooks & Knowledge Transfer

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IA-REL-006 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests runbooks & knowledge transfer for the project |
...
|----|--------|--------|-------------|
| S-001 | sa-runbooks-knowledge-transfer-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Runbooks & Knowledge Transfer is finalized (after supervisor approval) |
