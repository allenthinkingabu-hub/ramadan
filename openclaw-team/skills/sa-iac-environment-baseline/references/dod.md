# Definition of Done (DoD) — IA-DEV-006 IaC & Environment Baseline

Quality gates that must ALL pass for IaC & Environment Baseline deliverables to be considered complete.
