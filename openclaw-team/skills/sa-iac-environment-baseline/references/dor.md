# Definition of Ready (DoR) — IA-DEV-006 IaC & Environment Baseline

Prerequisites that must be satisfied before starting IaC & Environment Baseline.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-DEV-006/` |
