# Definition of Done (DoD) — IA-DEV-005 Architecture Decision Records (ADRs)

Quality gates that must ALL pass for Architecture Decision Records (ADRs) deliverables to be considered complete.
