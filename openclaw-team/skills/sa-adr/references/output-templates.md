# Output Template — IA-DEV-005 Architecture Decision Records (ADRs)

Use this template as the strict structure for all Architecture Decision Records (ADRs) deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Architecture Decision Records (ADRs) Document |
...
{{Core content specific to Architecture Decision Records (ADRs). Structure according to the deliverable type.}}
