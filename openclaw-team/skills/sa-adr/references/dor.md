# Definition of Ready (DoR) — IA-DEV-005 Architecture Decision Records (ADRs)

Prerequisites that must be satisfied before starting Architecture Decision Records (ADRs).
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-DEV-005/` |
