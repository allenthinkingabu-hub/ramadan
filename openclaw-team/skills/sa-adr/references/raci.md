# RACI Matrix — IA-DEV-005 Architecture Decision Records (ADRs)
...
| ID | Role | Description |
|----|------|-------------|
| SA | System Architect | Primary executor; produces and delivers Architecture Decision Records (ADRs) outputs |
