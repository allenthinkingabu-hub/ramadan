# Standard Operating Procedure (SOP) — IA-DEV-005 Architecture Decision Records (ADRs)

## Overview

Step-by-step process from receiving the Architecture Decision Records (ADRs) task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-DEV-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-adr-supervisor | Signal sent |
