---
name: pm-project-plan-wbs-supervisor
description: "Supervisor inspection skill for pm-project-plan-wbs. Use when: (1) PM agent completes self-check for task PM-REQ-001, (2) SupervisorTriggered event received from pm-project-plan-wbs skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Project Plan & WBS — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REQ-001 | Inspection Agent

## Inspection Scope

Independent quality review of the Project Plan & WBS output for task PM-REQ-001. This supervisor:
- Operates independently from the PM Project Plan & WBS agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Project Plan & WBS agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Project Plan & WBS agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Project Plan & WBS Supervisor Inspection Report
