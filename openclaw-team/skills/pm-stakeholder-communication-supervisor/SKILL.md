---
name: pm-stakeholder-communication-supervisor
description: "Supervisor inspection skill for pm-stakeholder-communication. Use when: (1) PM agent completes self-check for task PM-DEV-005, (2) SupervisorTriggered event received from pm-stakeholder-communication skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Stakeholder Communication — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-DEV-005 | Inspection Agent

## Inspection Scope

Independent quality review of the Stakeholder Communication output for task PM-DEV-005. This supervisor:
- Operates independently from the PM Stakeholder Communication agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Stakeholder Communication agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Stakeholder Communication agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Stakeholder Communication Supervisor Inspection Report
