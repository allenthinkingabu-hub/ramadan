#!/usr/bin/env python3
"""DoD Self-Verification Script for SA-feasibility-analysis Agent.

Checks all DoD items and reports pass/fail status.

Usage:
    python3 verify_dod.py <feasibility-analysis-dir>

Example:
    python3 verify_dod.py ./feasibility-analysis
"""
...
def main():
    if len(sys.argv) < 2:
        print("Usage: python3 verify_dod.py <feasibility-analysis-dir>")
        sys.exit(1)
    ...
    # DoD-14: Feasibility Analysis report
    results.append(("DoD-14", "Feasibility Analysis report",
                     *check_md_file(base / "feasibility-analysis-report.md")))
    ...
    print(f"\n{'='*70}")
    print(f"DoD Verification Report — Feasibility Analysis (IA-INC-002)")
