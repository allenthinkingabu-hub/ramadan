# Definition of Done (DoD) — IPM-DEV-003 PRD Change Management

Quality gates that must ALL pass for PRD Change Management deliverables to be considered complete.
