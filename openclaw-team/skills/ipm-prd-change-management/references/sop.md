# Standard Operating Procedure (SOP) — IPM-DEV-003 PRD Change Management

## Overview

Step-by-step process from receiving the PRD Change Management task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-DEV-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-prd-change-management-supervisor | Signal sent |
