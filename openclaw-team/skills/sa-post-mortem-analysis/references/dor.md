# Definition of Ready (DoR) — IA-REL-004 Post-Mortem Analysis

Prerequisites that must be satisfied before starting Post-Mortem Analysis.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-004/` |
