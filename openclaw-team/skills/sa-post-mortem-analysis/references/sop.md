# Standard Operating Procedure (SOP) — IA-REL-004 Post-Mortem Analysis

## Overview

Step-by-step process from receiving the Post-Mortem Analysis task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-post-mortem-analysis-supervisor | Signal sent |
