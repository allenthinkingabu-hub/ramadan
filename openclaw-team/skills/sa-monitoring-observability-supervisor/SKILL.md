---
name: sa-monitoring-observability-supervisor
description: "Supervisor inspection skill for sa-monitoring-observability. Use when: (1) SA agent completes self-check for task IA-REL-002, (2) SupervisorTriggered event received from sa-monitoring-observability skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Monitoring & Observability — Supervisor

Role: System Architect Supervisor | Task ID: IA-REL-002 | Inspection Agent

## Inspection Scope

Independent quality review of the Monitoring & Observability output for task IA-REL-002. This supervisor:
- Operates independently from the SA Monitoring & Observability agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Monitoring & Observability agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Monitoring & Observability agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Monitoring & Observability Supervisor Inspection Report
