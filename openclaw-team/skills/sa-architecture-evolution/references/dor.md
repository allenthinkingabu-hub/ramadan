# Definition of Ready (DoR) — IA-REL-005 Architecture Evolution

Prerequisites that must be satisfied before starting Architecture Evolution.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-005/` |
