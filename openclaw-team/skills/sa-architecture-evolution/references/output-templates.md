# Output Template — IA-REL-005 Architecture Evolution

Use this template as the strict structure for all Architecture Evolution deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Architecture Evolution Document |
...
{{Core content specific to Architecture Evolution. Structure according to the deliverable type.}}
