# Standard Operating Procedure (SOP) — IA-REL-005 Architecture Evolution

## Overview

Step-by-step process from receiving the Architecture Evolution task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-005/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-architecture-evolution-supervisor | Signal sent |
