# Definition of Ready (DoR) -- sa-data-privacy-governance
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or system to define data privacy governance for |
| DoR-02 | Scope is defined or definable | Yes | Data domains and regulatory scope stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `data-privacy-governance/` |
...
| DoR-13 | Business & regulatory requirements | Yes | Regulatory landscape and data requirements available or obtainable through dialogue |
