---
name: ipm-user-story-decomposition-supervisor
description: "Supervisor inspection skill for ipm-user-story-decomposition. Use when: (1) IPM agent completes self-check for task IPM-REQ-002, (2) SupervisorTriggered event received from ipm-user-story-decomposition skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# IPM User Story Decomposition — Supervisor

Role: IT Product Manager Supervisor | Task ID: IPM-REQ-002 | Inspection Agent

## Inspection Scope

Independent quality review of the User Story Decomposition output for task IPM-REQ-002. This supervisor:
- Operates independently from the IPM User Story Decomposition agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the IPM User Story Decomposition agent sends SupervisorTriggered event with:
...
```
[Trigger] IPM User Story Decomposition agent sends SupervisorTriggered
     |
     v
...
```markdown
# IPM User Story Decomposition Supervisor Inspection Report
