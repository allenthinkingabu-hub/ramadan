# Definition of Ready (DoR) — PM-DEV-001 Progress Tracking & Reporting

Prerequisites that must be satisfied before starting Progress Tracking & Reporting.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-DEV-001/` |
