# Standard Operating Procedure (SOP) — IPM-REL-002 Data Analysis

## Overview

Step-by-step process from receiving the Data Analysis task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REL-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-data-analysis-supervisor | Signal sent |
