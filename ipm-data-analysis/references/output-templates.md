# Output Template — IPM-REL-002 Data Analysis

Use this template as the strict structure for all Data Analysis deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Data Analysis Document |
...
{{Core content specific to Data Analysis. Structure according to the deliverable type.}}
