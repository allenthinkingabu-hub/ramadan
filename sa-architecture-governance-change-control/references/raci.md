# RACI Matrix — IA-REL-009 Architecture Governance & Change Control
...
| ID | Role | Description |
|----|------|-------------|
| SA | System Architect | Primary executor; produces and delivers Architecture Governance & Change Control outputs |
