# Standard Operating Procedure (SOP) — IA-REL-009 Architecture Governance & Change Control

## Overview

Step-by-step process from receiving the Architecture Governance & Change Control task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-009/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-architecture-governance-change-control-supervisor | Signal sent |
