# Output Template — IA-REL-009 Architecture Governance & Change Control

Use this template as the strict structure for all Architecture Governance & Change Control deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Architecture Governance & Change Control Document |
...
{{Core content specific to Architecture Governance & Change Control. Structure according to the deliverable type.}}
