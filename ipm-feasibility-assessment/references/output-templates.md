# Output Template — IPM-INC-004 Feasibility Assessment

Use this template as the strict structure for all Feasibility Assessment deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Feasibility Assessment Document |
...
{{Core content specific to Feasibility Assessment. Structure according to the deliverable type.}}
