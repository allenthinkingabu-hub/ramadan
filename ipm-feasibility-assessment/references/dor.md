# Definition of Ready (DoR) — IPM-INC-004 Feasibility Assessment

Prerequisites that must be satisfied before starting Feasibility Assessment.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-INC-004/` |
