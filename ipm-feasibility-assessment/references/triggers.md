# Trigger Configuration — IPM-INC-004 Feasibility Assessment

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-INC-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests feasibility assessment for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-feasibility-assessment-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Feasibility Assessment is finalized (after supervisor approval) |
