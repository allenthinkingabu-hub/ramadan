---
name: ipm-feasibility-assessment
description: "IT Product Manager skill for Collaborating with technical teams to evaluate technical viability. Use when: (1) PM assigns task IPM-INC-004 via TaskTriggered event, (2) Inception phase feasibility assessment activities are needed, (3) orchestrating feasibility assessment deliverables for downstream team tasks."
---

# IPM Feasibility Assessment

Role: IT Product Manager | Task ID: IPM-INC-004 | Wave: 2, Step: 4

## Objective

Collaborating with technical teams to evaluate technical viability.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-INC-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why feasibility assessment is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-feasibility-assessment-supervisor`
