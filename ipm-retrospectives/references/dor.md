# Definition of Ready (DoR) — IPM-REL-004 Retrospectives

Prerequisites that must be satisfied before starting Retrospectives.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REL-004/` |
