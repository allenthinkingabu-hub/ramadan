# Output Template — IPM-REL-004 Retrospectives

Use this template as the strict structure for all Retrospectives deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Retrospectives Document |
...
{{Core content specific to Retrospectives. Structure according to the deliverable type.}}
