# Trigger Configuration — IPM-REL-004 Retrospectives

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REL-004 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests retrospectives for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-retrospectives-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Retrospectives is finalized (after supervisor approval) |
