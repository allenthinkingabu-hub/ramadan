---
name: ipm-retrospectives
description: "IT Product Manager skill for Organizing project/sprint retrospectives to optimize collaboration. Use when: (1) PM assigns task IPM-REL-004 via TaskTriggered event, (2) Release phase retrospectives activities are needed, (3) orchestrating retrospectives deliverables for downstream team tasks."
---

# IPM Retrospectives

Role: IT Product Manager | Task ID: IPM-REL-004 | Wave: 2, Step: 4

## Objective

Organizing project/sprint retrospectives to optimize collaboration.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REL-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why retrospectives is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-retrospectives-supervisor`
