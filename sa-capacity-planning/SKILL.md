---
name: sa-capacity-planning
description: "System Architect skill for Analyzing production data to forecast scaling needs and optimize resource utilization. Use when: (1) PM assigns task IA-REL-003 via TaskTriggered event, (2) Release phase capacity planning activities are needed, (3) orchestrating capacity planning deliverables for downstream team tasks."
---

# SA Capacity Planning

Role: System Architect | Task ID: IA-REL-003 | Wave: 10, Step: 3

## Objective

Analyzing production data to forecast scaling needs and optimize resource utilization.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why capacity planning is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-capacity-planning-supervisor`
