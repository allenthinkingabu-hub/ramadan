# Standard Operating Procedure (SOP) — PM-REL-003 Project Closure

## Overview

Step-by-step process from receiving the Project Closure task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REL-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-project-closure-supervisor | Signal sent |
