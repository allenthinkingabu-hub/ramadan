# Trigger Configuration — PM-REL-003 Project Closure

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches PM-REL-003 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests project closure for the project |
...
|----|--------|--------|-------------|
| S-001 | pm-project-closure-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that Project Closure is finalized (after supervisor approval) |
