---
name: pm-benefits-handover-supervisor
description: "Supervisor inspection skill for pm-benefits-handover. Use when: (1) PM agent completes self-check for task PM-REL-005, (2) SupervisorTriggered event received from pm-benefits-handover skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Benefits Handover — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REL-005 | Inspection Agent

## Inspection Scope

Independent quality review of the Benefits Handover output for task PM-REL-005. This supervisor:
- Operates independently from the PM Benefits Handover agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Benefits Handover agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Benefits Handover agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Benefits Handover Supervisor Inspection Report
