# Definition of Done (DoD) — IA-QA-004 Integration Testing Support

Quality gates that must ALL pass for Integration Testing Support deliverables to be considered complete.
