---
name: sa-integration-testing-support
description: "System Architect skill for Ensuring end-to-end integration points function correctly across system boundaries. Use when: (1) PM assigns task IA-QA-004 via TaskTriggered event, (2) QA phase integration testing support activities are needed, (3) orchestrating integration testing support deliverables for downstream team tasks."
---

# SA Integration Testing Support

Role: System Architect | Task ID: IA-QA-004 | Wave: 10, Step: 4

## Objective

Ensuring end-to-end integration points function correctly across system boundaries.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-QA-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why integration testing support is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-integration-testing-support-supervisor`
