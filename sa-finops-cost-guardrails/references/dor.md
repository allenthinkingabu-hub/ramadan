# Definition of Ready (DoR) — IA-REL-007 FinOps & Cost Guardrails

Prerequisites that must be satisfied before starting FinOps & Cost Guardrails.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-REL-007/` |
