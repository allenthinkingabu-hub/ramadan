# Standard Operating Procedure (SOP) — IA-REL-002 Monitoring & Observability

## Overview

Step-by-step process from receiving the Monitoring & Observability task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-REL-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-monitoring-observability-supervisor | Signal sent |
