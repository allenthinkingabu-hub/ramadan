---
name: sa-adr
description: "System Architect skill for Documenting key technical decisions, rationale, and trade-offs for future reference. Use when: (1) PM assigns task IA-DEV-005 via TaskTriggered event, (2) Development phase architecture decision records (adrs) activities are needed, (3) orchestrating architecture decision records (adrs) deliverables for downstream team tasks."
---

# SA Architecture Decision Records (ADRs)

Role: System Architect | Task ID: IA-DEV-005 | Wave: 10, Step: 5

## Objective

Documenting key technical decisions, rationale, and trade-offs for future reference.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-DEV-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why architecture decision records (adrs) is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-adr-supervisor`
