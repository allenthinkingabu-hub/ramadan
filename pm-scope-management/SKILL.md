---
name: pm-scope-management
description: "IT Project Manager skill for Controlling scope through formal change request processes, impact assessments, and change control board decisions. Use when: (1) PM assigns task PM-DEV-003 via TaskTriggered event, (2) Development phase scope management activities are needed, (3) orchestrating scope management deliverables for downstream team tasks."
---

# PM Scope Management

Role: IT Project Manager | Task ID: PM-DEV-003 | Wave: 1, Step: 3

## Objective

Controlling scope through formal change request processes, impact assessments, and change control board decisions.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-DEV-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why scope management is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-scope-management-supervisor`
