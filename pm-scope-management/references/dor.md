# Definition of Ready (DoR) — PM-DEV-003 Scope Management

Prerequisites that must be satisfied before starting Scope Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-DEV-003/` |
