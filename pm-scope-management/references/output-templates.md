# Output Template — PM-DEV-003 Scope Management

Use this template as the strict structure for all Scope Management deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Scope Management Document |
...
{{Core content specific to Scope Management. Structure according to the deliverable type.}}
