---
name: pm-compliance-audit-readiness-supervisor
description: "Supervisor inspection skill for pm-compliance-audit-readiness. Use when: (1) PM agent completes self-check for task PM-QA-004, (2) SupervisorTriggered event received from pm-compliance-audit-readiness skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Compliance & Audit Readiness — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-QA-004 | Inspection Agent

## Inspection Scope

Independent quality review of the Compliance & Audit Readiness output for task PM-QA-004. This supervisor:
- Operates independently from the PM Compliance & Audit Readiness agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Compliance & Audit Readiness agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Compliance & Audit Readiness agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Compliance & Audit Readiness Supervisor Inspection Report
