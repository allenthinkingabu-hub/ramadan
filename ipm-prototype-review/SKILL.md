---
name: ipm-prototype-review
description: "IT Product Manager skill for Collaborating with designers to finalize UI/UX solutions. Use when: (1) PM assigns task IPM-REQ-004 via TaskTriggered event, (2) Requirements phase prototype review activities are needed, (3) orchestrating prototype review deliverables for downstream team tasks."
---

# IPM Prototype Review

Role: IT Product Manager | Task ID: IPM-REQ-004 | Wave: 2, Step: 4

## Objective

Collaborating with designers to finalize UI/UX solutions.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why prototype review is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-prototype-review-supervisor`
