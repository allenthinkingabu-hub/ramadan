---
name: sa-integration-testing-support-supervisor
description: "Supervisor inspection skill for sa-integration-testing-support. Use when: (1) SA agent completes self-check for task IA-QA-004, (2) SupervisorTriggered event received from sa-integration-testing-support skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Integration Testing Support — Supervisor

Role: System Architect Supervisor | Task ID: IA-QA-004 | Inspection Agent

## Inspection Scope

Independent quality review of the Integration Testing Support output for task IA-QA-004. This supervisor:
- Operates independently from the SA Integration Testing Support agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Integration Testing Support agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Integration Testing Support agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Integration Testing Support Supervisor Inspection Report
