# Definition of Ready (DoR) — IA-QA-003 Infrastructure Validation

Prerequisites that must be satisfied before starting Infrastructure Validation.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-sa/outputs/IA-QA-003/` |
