---
name: ipm-user-story-decomposition
description: "IT Product Manager skill for Breaking down large requirements into deliverable User Stories (Definition of Ready - DoR). Use when: (1) PM assigns task IPM-REQ-002 via TaskTriggered event, (2) Requirements phase user story decomposition activities are needed, (3) orchestrating user story decomposition deliverables for downstream team tasks."
---

# IPM User Story Decomposition

Role: IT Product Manager | Task ID: IPM-REQ-002 | Wave: 2, Step: 2

## Objective

Breaking down large requirements into deliverable User Stories (Definition of Ready - DoR).

## Upstream Inputs

- **PM Agent**: Project Charter, Stakeholder Analysis, Resource Plan from Wave 1
- **Previous IPM phase outputs**: Completed Requirements prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- SM-REQ-001, SM-REQ-002, SM-REQ-003, SM-REQ-004, SM-REQ-005

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why user story decomposition is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-user-story-decomposition-supervisor`
