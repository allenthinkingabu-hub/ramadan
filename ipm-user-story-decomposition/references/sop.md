# Standard Operating Procedure (SOP) — IPM-REQ-002 User Story Decomposition

## Overview

Step-by-step process from receiving the User Story Decomposition task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-REQ-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-user-story-decomposition-supervisor | Signal sent |
