# Trigger Configuration — IPM-REQ-002 User Story Decomposition

## Primary Triggers (any one activates)

| ID | Type | Description |
|----|------|-------------|
| T-001 | TaskTriggered event | PM dispatches IPM-REQ-002 via event bus |
| T-002 | Upstream completion | Upstream prerequisite tasks completed |
| T-003 | User invocation | User explicitly requests user story decomposition for the project |
...
|----|--------|--------|-------------|
| S-001 | ipm-user-story-decomposition-supervisor | SupervisorTriggered | Triggers supervisor review of output |
| S-002 | PM Agent | TaskCompleted | Notifies PM that User Story Decomposition is finalized (after supervisor approval) |
