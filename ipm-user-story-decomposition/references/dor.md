# Definition of Ready (DoR) — IPM-REQ-002 User Story Decomposition

Prerequisites that must be satisfied before starting User Story Decomposition.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-REQ-002/` |
