# Definition of Ready (DoR) -- sa-risk-identification
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or system to assess for technical risks |
...
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `risk-identification/` |
