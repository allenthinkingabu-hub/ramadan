# Output Template — IA-DEV-006 IaC & Environment Baseline

Use this template as the strict structure for all IaC & Environment Baseline deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — IaC & Environment Baseline Document |
...
{{Core content specific to IaC & Environment Baseline. Structure according to the deliverable type.}}
