# Standard Operating Procedure (SOP) — IA-DEV-006 IaC & Environment Baseline

## Overview

Step-by-step process from receiving the IaC & Environment Baseline task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-sa/outputs/IA-DEV-006/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to sa-iac-environment-baseline-supervisor | Signal sent |
