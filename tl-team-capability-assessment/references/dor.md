# Definition of Ready (DoR) — tl-team-capability-assessment
...
|:---|:---|:---:|:---|
| DoR-01 | Topic is provided | Yes | User has supplied the project or team for capability assessment |
| DoR-02 | Scope is defined or definable | Yes | Assessment scope boundaries stated or clarifiable in Step 1 |
| DoR-03 | User is available for dialogue | Yes | User can participate in iterative Q&A (Steps 1-3) |
| DoR-04 | Output directory is writable | Yes | Parent directory exists and agent can create `team-capability-assessment/` |
...
| DoR-14 | Team composition information | Yes | Team roster and role assignments available or obtainable through dialogue |
...
5. Check for team composition information -> if available, load as additional context
