---
name: ipm-user-feedback
description: "IT Product Manager skill for Collecting continuous feedback for the next iteration cycle. Use when: (1) PM assigns task IPM-REL-003 via TaskTriggered event, (2) Release phase user feedback activities are needed, (3) orchestrating user feedback deliverables for downstream team tasks."
---

# IPM User Feedback

Role: IT Product Manager | Task ID: IPM-REL-003 | Wave: 2, Step: 3

## Objective

Collecting continuous feedback for the next iteration cycle.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REL-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why user feedback is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-user-feedback-supervisor`
