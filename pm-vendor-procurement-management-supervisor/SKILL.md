---
name: pm-vendor-procurement-management-supervisor
description: "Supervisor inspection skill for pm-vendor-procurement-management. Use when: (1) PM agent completes self-check for task PM-REQ-005, (2) SupervisorTriggered event received from pm-vendor-procurement-management skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Vendor & Procurement Management — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REQ-005 | Inspection Agent

## Inspection Scope

Independent quality review of the Vendor & Procurement Management output for task PM-REQ-005. This supervisor:
- Operates independently from the PM Vendor & Procurement Management agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Vendor & Procurement Management agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Vendor & Procurement Management agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Vendor & Procurement Management Supervisor Inspection Report
