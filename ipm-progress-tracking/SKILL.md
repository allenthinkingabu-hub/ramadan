---
name: ipm-progress-tracking
description: "IT Product Manager skill for Monitoring delivery timelines and identifying risks early. Use when: (1) PM assigns task IPM-DEV-004 via TaskTriggered event, (2) Development phase progress tracking activities are needed, (3) orchestrating progress tracking deliverables for downstream team tasks."
---

# IPM Progress Tracking

Role: IT Product Manager | Task ID: IPM-DEV-004 | Wave: 2, Step: 4

## Objective

Monitoring delivery timelines and identifying risks early.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why progress tracking is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-progress-tracking-supervisor`
