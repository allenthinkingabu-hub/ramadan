# Definition of Ready (DoR) — IPM-DEV-004 Progress Tracking

Prerequisites that must be satisfied before starting Progress Tracking.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-004/` |
