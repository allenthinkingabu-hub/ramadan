# Output Template — IPM-INC-005 Alignment

Use this template as the strict structure for all Alignment deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Alignment Document |
...
{{Core content specific to Alignment. Structure according to the deliverable type.}}
