---
name: ipm-alignment
description: "IT Product Manager skill for Achieving consensus among business, technical, and design stakeholders. Use when: (1) PM assigns task IPM-INC-005 via TaskTriggered event, (2) Inception phase alignment activities are needed, (3) orchestrating alignment deliverables for downstream team tasks."
---

# IPM Alignment

Role: IT Product Manager | Task ID: IPM-INC-005 | Wave: 2, Step: 5

## Objective

Achieving consensus among business, technical, and design stakeholders.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-INC-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why alignment is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-alignment-supervisor`
