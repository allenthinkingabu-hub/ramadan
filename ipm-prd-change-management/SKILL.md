---
name: ipm-prd-change-management
description: "IT Product Manager skill for Managing requirement changes and assessing their impact. Use when: (1) PM assigns task IPM-DEV-003 via TaskTriggered event, (2) Development phase prd change management activities are needed, (3) orchestrating prd change management deliverables for downstream team tasks."
---

# IPM PRD Change Management

Role: IT Product Manager | Task ID: IPM-DEV-003 | Wave: 2, Step: 3

## Objective

Managing requirement changes and assessing their impact.
...
1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why prd change management is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-prd-change-management-supervisor`
