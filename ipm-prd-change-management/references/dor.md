# Definition of Ready (DoR) — IPM-DEV-003 PRD Change Management

Prerequisites that must be satisfied before starting PRD Change Management.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-DEV-003/` |
