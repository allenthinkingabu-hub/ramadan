# Output Template — IPM-DEV-003 PRD Change Management

Use this template as the strict structure for all PRD Change Management deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — PRD Change Management Document |
...
{{Core content specific to PRD Change Management. Structure according to the deliverable type.}}
