# Definition of Done (DoD) — PM-REQ-003 RACI Matrix Definition

Quality gates that must ALL pass for RACI Matrix Definition deliverables to be considered complete.
