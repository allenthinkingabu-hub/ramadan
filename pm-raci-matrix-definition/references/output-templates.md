# Output Template — PM-REQ-003 RACI Matrix Definition

Use this template as the strict structure for all RACI Matrix Definition deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — RACI Matrix Definition Document |
...
{{Core content specific to RACI Matrix Definition. Structure according to the deliverable type.}}
