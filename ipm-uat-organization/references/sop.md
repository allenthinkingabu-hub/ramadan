# Standard Operating Procedure (SOP) — IPM-QA-001 UAT Organization

## Overview

Step-by-step process from receiving the UAT Organization task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-ipm/outputs/IPM-QA-001/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to ipm-uat-organization-supervisor | Signal sent |
