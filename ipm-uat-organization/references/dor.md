# Definition of Ready (DoR) — IPM-QA-001 UAT Organization

Prerequisites that must be satisfied before starting UAT Organization.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-ipm/outputs/IPM-QA-001/` |
