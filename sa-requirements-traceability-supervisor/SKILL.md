---
name: sa-requirements-traceability-supervisor
description: "Supervisor inspection skill for sa-requirements-traceability. Use when: (1) SA agent completes self-check for task IA-REQ-009, (2) SupervisorTriggered event received from sa-requirements-traceability skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Requirements Traceability & Compliance Mapping — Supervisor

Role: System Architect Supervisor | Task ID: IA-REQ-009 | Inspection Agent

## Inspection Scope

Independent quality review of the Requirements Traceability & Compliance Mapping output for task IA-REQ-009. This supervisor:
- Operates independently from the SA Requirements Traceability & Compliance Mapping agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Requirements Traceability & Compliance Mapping agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Requirements Traceability & Compliance Mapping agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Requirements Traceability & Compliance Mapping Supervisor Inspection Report
