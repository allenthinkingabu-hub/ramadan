---
name: pm-schedule-development-supervisor
description: "Supervisor inspection skill for pm-schedule-development. Use when: (1) PM agent completes self-check for task PM-REQ-002, (2) SupervisorTriggered event received from pm-schedule-development skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# PM Schedule Development — Supervisor

Role: IT Project Manager Supervisor | Task ID: PM-REQ-002 | Inspection Agent

## Inspection Scope

Independent quality review of the Schedule Development output for task PM-REQ-002. This supervisor:
- Operates independently from the PM Schedule Development agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the PM Schedule Development agent sends SupervisorTriggered event with:
...
```
[Trigger] PM Schedule Development agent sends SupervisorTriggered
     |
     v
...
```markdown
# PM Schedule Development Supervisor Inspection Report
