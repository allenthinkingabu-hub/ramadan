# Definition of Done (DoD) — IA-REL-005 Architecture Evolution

Quality gates that must ALL pass for Architecture Evolution deliverables to be considered complete.
