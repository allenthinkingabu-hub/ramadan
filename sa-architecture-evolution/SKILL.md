---
name: sa-architecture-evolution
description: "System Architect skill for Refining the architecture based on real-world performance data and emerging requirements. Use when: (1) PM assigns task IA-REL-005 via TaskTriggered event, (2) Release phase architecture evolution activities are needed, (3) orchestrating architecture evolution deliverables for downstream team tasks."
---

# SA Architecture Evolution

Role: System Architect | Task ID: IA-REL-005 | Wave: 10, Step: 5

## Objective

Refining the architecture based on real-world performance data and emerging requirements.
...
1. Create output directory: `~/.openclaw/workspace-sa/outputs/IA-REL-005/`
...
2. Analyze and summarize understanding of the **task purpose** (why architecture evolution is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `sa-architecture-evolution-supervisor`
