---
name: tl-code-review-quality-gatekeeping-supervisor
description: "Independent Quality Supervisor AI Agent skill for end-to-end quality monitoring and closed-loop remediation of the tl-code-review-quality-gatekeeping agent output. Use when: (1) the Code Review & Quality Gatekeeping Agent (TL-DEV-001) completes one round of output and needs quality inspection, (2) verifying all required deliverables are complete and valid, or (3) ensuring closed-loop quality remediation before handoff to PM Agent."
---

# TL Code Review & Quality Gatekeeping Supervisor Agent

Role: Quality Supervisor | Parent Task: TL-DEV-001 Code Review & Quality Gatekeeping | Wave: 11, Step: 1

Operates independently from the Code Review & Quality Gatekeeping Agent. Does not participate in the work -- only reviews and provides feedback.

## Trigger

Automatically triggered after the Code Review & Quality Gatekeeping AI Agent completes one round of output.
...
| 14 | Review standards document | `review-standards.md` exists with review types, severity classification, escalation |
| 15 | Quality gate report | `quality-gate-report.md` exists with gate definitions, thresholds, compliance tracking |
| 16 | Architectural compliance | Review checklist includes architecture pattern verification against IA-REQ-001 |
| 17 | Upstream traceability | Architecture design references present, review standards traceable to requirements |

## Inspection Process

```
[Trigger] Code Review & Quality Gatekeeping Agent completes output
     |
...
```markdown
# Code Review & Quality Gatekeeping Supervisor Inspection Report
...
| Item 14: Review Standards Document | PASS / FAIL | {notes} |
| Item 15: Quality Gate Report | PASS / FAIL | {notes} |
| Item 16: Architectural Compliance | PASS / FAIL | {notes} |
...
2. Invoke PM Agent, sending:
   - Code Review Quality Gatekeeping report file path and filename
