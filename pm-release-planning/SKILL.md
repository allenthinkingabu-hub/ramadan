---
name: pm-release-planning
description: "IT Project Manager skill for Coordinating release schedules, deployment windows, and rollback contingencies with all involved teams. Use when: (1) PM assigns task PM-QA-003 via TaskTriggered event, (2) QA phase release planning activities are needed, (3) orchestrating release planning deliverables for downstream team tasks."
---

# PM Release Planning

Role: IT Project Manager | Task ID: PM-QA-003 | Wave: 1, Step: 3

## Objective

Coordinating release schedules, deployment windows, and rollback contingencies with all involved teams.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-QA-003/`
...
2. Analyze and summarize understanding of the **task purpose** (why release planning is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-release-planning-supervisor`
