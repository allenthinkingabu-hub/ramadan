# Definition of Ready (DoR) — PM-QA-003 Release Planning

Prerequisites that must be satisfied before starting Release Planning.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-QA-003/` |
