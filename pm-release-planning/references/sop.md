# Standard Operating Procedure (SOP) — PM-QA-003 Release Planning

## Overview

Step-by-step process from receiving the Release Planning task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-QA-003/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-release-planning-supervisor | Signal sent |
