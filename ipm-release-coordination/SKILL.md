---
name: ipm-release-coordination
description: "IT Product Manager skill for Planning release schedules, canary deployments, and rollback strategies. Use when: (1) PM assigns task IPM-REL-001 via TaskTriggered event, (2) Release phase release coordination activities are needed, (3) orchestrating release coordination deliverables for downstream team tasks."
---

# IPM Release Coordination

Role: IT Product Manager | Task ID: IPM-REL-001 | Wave: 2, Step: 1

## Objective

Planning release schedules, canary deployments, and rollback strategies.

## Upstream Inputs

- **PM Agent**: Project Charter, Stakeholder Analysis, Resource Plan from Wave 1
- **Previous IPM phase outputs**: Completed Release prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- SM-REL-001, SM-REL-002, SM-REL-003, SM-REL-004

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-ipm/outputs/IPM-REL-001/`
...
2. Analyze and summarize understanding of the **task purpose** (why release coordination is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `ipm-release-coordination-supervisor`
