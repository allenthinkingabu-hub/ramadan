---
name: pm-budget-estimation
description: "IT Project Manager skill for Developing initial cost estimates covering personnel, infrastructure, licensing, and contingency reserves. Use when: (1) PM assigns task PM-INC-004 via TaskTriggered event, (2) Inception phase budget estimation activities are needed, (3) orchestrating budget estimation deliverables for downstream team tasks."
---

# PM Budget Estimation

Role: IT Project Manager | Task ID: PM-INC-004 | Wave: 1, Step: 4

## Objective

Developing initial cost estimates covering personnel, infrastructure, licensing, and contingency reserves.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-INC-004/`
...
2. Analyze and summarize understanding of the **task purpose** (why budget estimation is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-budget-estimation-supervisor`
