# Standard Operating Procedure (SOP) — PM-INC-004 Budget Estimation

## Overview

Step-by-step process from receiving the Budget Estimation task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-INC-004/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-budget-estimation-supervisor | Signal sent |
