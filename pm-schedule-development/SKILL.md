---
name: pm-schedule-development
description: "IT Project Manager skill for Building project timelines using Gantt charts, defining dependencies, and setting baseline schedules. Use when: (1) PM assigns task PM-REQ-002 via TaskTriggered event, (2) Requirements phase schedule development activities are needed, (3) orchestrating schedule development deliverables for downstream team tasks."
---

# PM Schedule Development

Role: IT Project Manager | Task ID: PM-REQ-002 | Wave: 1, Step: 2

## Objective

Building project timelines using Gantt charts, defining dependencies, and setting baseline schedules.
...
1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-REQ-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why schedule development is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-schedule-development-supervisor`
