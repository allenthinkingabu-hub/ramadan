# Standard Operating Procedure (SOP) — PM-REQ-002 Schedule Development

## Overview

Step-by-step process from receiving the Schedule Development task to delivering complete, supervisor-approved deliverables. Each phase must complete before the next begins.
...
| Step | Action | Output |
|------|--------|--------|
| 0.1 | Create output directory `~/.openclaw/workspace-pm/outputs/PM-REQ-002/` | Directory created |
...
| 5.6 | Send SupervisorTriggered to pm-schedule-development-supervisor | Signal sent |
