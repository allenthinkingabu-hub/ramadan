---
name: sa-technical-debt-management-supervisor
description: "Supervisor inspection skill for sa-technical-debt-management. Use when: (1) SA agent completes self-check for task IA-DEV-004, (2) SupervisorTriggered event received from sa-technical-debt-management skill, (3) quality gate verification needed before TaskCompleted is sent to PM."
---

# SA Technical Debt Management — Supervisor

Role: System Architect Supervisor | Task ID: IA-DEV-004 | Inspection Agent

## Inspection Scope

Independent quality review of the Technical Debt Management output for task IA-DEV-004. This supervisor:
- Operates independently from the SA Technical Debt Management agent
- Reviews only — never modifies deliverables directly
- Must achieve 100% pass rate before TaskCompleted can be sent to PM

## Trigger

Activated when the SA Technical Debt Management agent sends SupervisorTriggered event with:
...
```
[Trigger] SA Technical Debt Management agent sends SupervisorTriggered
     |
     v
...
```markdown
# SA Technical Debt Management Supervisor Inspection Report
