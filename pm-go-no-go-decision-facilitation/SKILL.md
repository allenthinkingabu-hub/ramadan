---
name: pm-go-no-go-decision-facilitation
description: "IT Project Manager skill for Organizing go/no-go review meetings with key stakeholders based on quality metrics and risk assessment. Use when: (1) PM assigns task PM-QA-002 via TaskTriggered event, (2) QA phase go/no-go decision facilitation activities are needed, (3) orchestrating go/no-go decision facilitation deliverables for downstream team tasks."
---

# PM Go/No-Go Decision Facilitation

Role: IT Project Manager | Task ID: PM-QA-002 | Wave: 1, Step: 2

## Objective

Organizing go/no-go review meetings with key stakeholders based on quality metrics and risk assessment.

## Upstream Inputs

- **User / Organization**: Project initiation request and strategic objectives
- **Previous PM phase outputs**: Completed QA prerequisites

## Downstream Triggers

On TaskCompleted (after supervisor 100% pass):
- IPM-QA-001, IPM-QA-002, IPM-QA-003

## Workflow (Phase 0-5)

### Phase 0: Initialization

1. Create output directory: `~/.openclaw/workspace-pm/outputs/PM-QA-002/`
...
2. Analyze and summarize understanding of the **task purpose** (why go/no-go decision facilitation is needed)
...
7. Invoke supervisor: send SupervisorTriggered event to `pm-go-no-go-decision-facilitation-supervisor`
