# Definition of Ready (DoR) — PM-QA-002 Go/No-Go Decision Facilitation

Prerequisites that must be satisfied before starting Go/No-Go Decision Facilitation.
...
| DOR-009 | Output location defined | Yes | User input or default | Default: `~/.openclaw/workspace-pm/outputs/PM-QA-002/` |
