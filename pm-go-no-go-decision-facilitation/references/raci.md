# RACI Matrix — PM-QA-002 Go/No-Go Decision Facilitation
...
| ID | Role | Description |
|----|------|-------------|
| PM | IT Project Manager | Primary executor; produces and delivers Go/No-Go Decision Facilitation outputs |
...
| ID | Task | PM | PM | SPONSOR | SME | END_USER | ARCHITECT | QA |
|----|------|-----|-----|---------|-----|----------|-----------|-----|
