# Output Template — PM-QA-002 Go/No-Go Decision Facilitation

Use this template as the strict structure for all Go/No-Go Decision Facilitation deliverables. Every section must be populated with meaningful content. No section may be empty or contain placeholder text in the final output.
...
| Field | Value |
|-------|-------|
| Document Title | {{project_name}} — Go/No-Go Decision Facilitation Document |
| Version | {{version_number}} |
| Date | {{date}} |
| Author | IT Project Manager AI Agent |
...
|---------|------|--------|-------------|
| 0.1 | {{date}} | IT Project Manager AI Agent | Initial draft |
...
{{Core content specific to Go/No-Go Decision Facilitation. Structure according to the deliverable type.}}
...
| IT Project Manager | AI Agent | _________ | {{date}} |
